...
2. Introduction to principles of dynamic programming – Computing Fibonacci numbers: Top-down vs. bottom-up – Repeated sub-problems, ordering compute, table lookup
...
– Additive score, building up a solution from smaller parts – Prefix matrix: finite subproblems, exponential paths – Duality: each entryprefix alignment score; pathaligmnt
...
[← • Setting up dynamic programming](23-setting-up-dynamic-programming.md) · [Up: contents](index.md) · [(3) How do we apply dynamic programming to sequence alignment ? →](25-3-how-do-we-apply-dynamic-programming-to-sequence-alignment.md)
