...
[← Step 3: Trace back pointers to construct alignment](35-step-3-trace-back-pointers-to-construct-alignment.md) · [Up: contents](index.md) · [What is missing? (5) Returning the actual path! →](37-what-is-missing-5-returning-the-actual-path.md)
