...
[← Goal: Sequence Alignment / Dynamic Programming](38-goal-sequence-alignment-dynamic-programming.md) · [Up: contents](index.md) · [(4) Extensions to basic DP solution →](40-4-extensions-to-basic-dp-solution.md)
