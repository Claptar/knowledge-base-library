...
– Duality: each entryprefix alignment score; pathaligmnt 4. Advanced topics: Dynamic Programming variants

– Linear-time bounded DP(heuristic). Linear-space DP. Gaps – Importance of parameterization: 2-D vs. 4-D decomposition

54

---

[← 02 slides Part 47 —](47-02-slides-part-47.md) · [Up: contents](index.md) · [Additional insights →](49-additional-insights.md)
