...
**4. Deterministic linear-time exact string matching** – Key insight: gather more info from each comparison
...
[← Extension 3: Combs and Random Projections](29-extension-3-combs-and-random-projections.md) · [Up: contents](index.md) · [The exact matching problem →](31-the-exact-matching-problem.md)
