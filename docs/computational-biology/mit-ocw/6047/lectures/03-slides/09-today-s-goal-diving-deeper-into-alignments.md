...
[← Today’s Goal: Diving deeper into alignments](08-today-s-goal-diving-deeper-into-alignments.md) · [Up: contents](index.md) · [Intro to Local Alignments →](10-intro-to-local-alignments.md)
