...
1. Global alignment vs. Local alignment – Variations on initialization, termination, update rule
...
[← Sequence alignment with generalized gap penalties](14-sequence-alignment-with-generalized-gap-penalties.md) · [Up: contents](index.md) · [Linear-time string matching →](16-linear-time-string-matching.md)
