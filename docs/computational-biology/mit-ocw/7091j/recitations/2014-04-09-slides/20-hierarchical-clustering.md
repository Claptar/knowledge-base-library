...
- ( **repeat   unKl   only   1   cluster   leT** )   –   calculate   distances   between each   pair   of   clusters,   merge   the   two   closest   into   single   cluster – use **centroid** linkage


Only   two   clusters lej,   merge   them. Update   dendogram: 1 2 3 4 6 5 7
...
[← Hierarchical Clustering](19-hierarchical-clustering.md) · [Up: contents](index.md) · [Hierarchical Clustering →](21-hierarchical-clustering.md)
