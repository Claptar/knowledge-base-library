...
- Size and constraints on transition matrix P ?
...
Interpretation: From current state _i_ , you must end up in _some_ state _j_ after transition

---

[← Markov Chains](03-markov-chains.md) · [Up: contents](index.md) · [Markov Models (Chains) →](05-markov-models-chains.md)
