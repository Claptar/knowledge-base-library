...
Input: 254 expression profiles in B cells (normal and tumor) various sets of candidate regulators Evaluation:
...
[← Model](59-model.md) · [Up: contents](index.md) · [What regulates MYC? →](61-what-regulates-myc.md)
