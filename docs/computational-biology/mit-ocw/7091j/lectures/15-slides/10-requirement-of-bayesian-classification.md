---
title: Requirement of Bayesian Classification
...
– No systematic bias Positive training data: MIPS • Hand-curated from literature Negative training data:
...
[← Integrating diverse data](09-integrating-diverse-data.md) · [Up: contents](index.md) · [Integrating diverse data →](11-integrating-diverse-data.md)
