...
[← Move upstream of transcription Network Interactome integration](40-move-upstream-of-transcription-network-interactome-integrati.md) · [Up: contents](index.md) · [Genetic vs. Expression Data →](42-genetic-vs-expression-data.md)
