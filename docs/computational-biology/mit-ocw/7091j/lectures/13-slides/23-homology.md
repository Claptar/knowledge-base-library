...
Medium sequence similarity template(s) (20– 50% se **q** uence similarit **y)** .

- Proceed with several alignments

- Re **fi** ne structures

- Choose best model b **y** final ener **gy**

39

---

[← Homology](22-homology.md) · [Up: contents](index.md) · [Homology →](24-homology.md)
