---
title: 01 solutions qu01 f09 sol
source: https://ocw.mit.edu/courses/6-041sc-probabilistic-systems-analysis-and-applied-probability-fall-2013/
source_file: sources/ocw-6041sc/solutions/01-solutions-qu01-f09-sol.pdf
...
# 01 solutions qu01 f09 sol

**Source:** `solutions/01-solutions-qu01-f09-sol.pdf` from [ocw-6041sc](https://ocw.mit.edu/courses/6-041sc-probabilistic-systems-analysis-and-applied-probability-fall-2013/) · **Licence:** CC BY-NC-SA 4.0 · Converted 2026-09-14 from `.pdf` (lossy)
...
The probability of the event B can be computed by using the result in (a), where n = 20 and k = 10. P(B) = �2010�p10(1 − p)10. P(A ∩ B) can be computed by seperating the event of A and B into disjoint events. The event {A ∩ B} = {1st 10 apples picked are gala and the last 10 apples are honey crisp}. P(A ∩ B) = p<sup>10</sup> (1 − p)<sup>10</sup> . Therefore,
