...
|---|---|---|
|`as.numeric`|`1, 0, 1`|Integers or floating point<br>numbers.|
|`as.character`|`'1', '0', '1'`|Character strings. Generally<br>preferred to factors.|
|`as.factor`|`'1', '0', '1',`<br>`levels: '1', '0'`|Character strings with preset<br>levels. Needed for some<br>statistical models.|

---

[← Working Directory](03-working-directory.md) · [Up: contents](index.md) · [Maths Functions →](05-maths-functions.md)
