...
2. [Lineair Regression](02-lineair-regression.md)
3. [Parameter estimation](03-parameter-estimation.md)
4. [Statistical inference](04-statistical-inference.md)
5. [Assess assumptions](05-assess-assumptions.md)
