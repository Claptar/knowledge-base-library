---
title: Assess the research question with the two-sample t-test
...
[← Data Exploration](04-data-exploration.md) · [Up: contents](index.md) · [Train yourself in checking the assumptions →](06-train-yourself-in-checking-the-assumptions.md)
