---
title: or glimpse(NHANES) to see all the variables in the dataset
...
[← Data Import with the readr R package](02-data-import-with-the-readr-r-package.md) · [Up: contents](index.md) · [Data Tidying →](04-data-tidying.md)
