...
5. [deel grafische scherm op in 1 rij en 2 kolommen](05-deel-grafische-scherm-op-in-1-rij-en-2-kolommen.md)
6. [teken een histogram](06-teken-een-histogram.md)
7. [teken een kernel density schatter](07-teken-een-kernel-density-schatter.md)
8. [argument na.rm=TRUE omdat er ontbrekende](08-argument-na-rm-true-omdat-er-ontbrekende.md)
9. [waarnemingen (NA) voorkomen](09-waarnemingen-na-voorkomen.md)
10. [Het gebruik van functie sd() levert de standarddeviatie](10-het-gebruik-van-functie-sd-levert-de-standarddeviatie.md)
11. [van de variabele BMI in de NHANES dataset.](11-van-de-variabele-bmi-in-de-nhanes-dataset.md)
12. [Het na.rm=TRUE argument wordt gebruikt omdat er](12-het-na-rm-true-argument-wordt-gebruikt-omdat-er.md)
13. [ontbrekende waarnemingen voorkomen.](13-ontbrekende-waarnemingen-voorkomen.md)
14. [de & operater is een logische AND](14-de-operater-is-een-logische-and.md)
