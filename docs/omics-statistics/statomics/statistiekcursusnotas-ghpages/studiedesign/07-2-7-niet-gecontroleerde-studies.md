---
title: 2.7 Niet-gecontroleerde studies
...
# 2.7 Niet-gecontroleerde studies
...
### <span class="header-section-number">2.7.1</span> Pre-test/Post-test studies {#pre-testpost-test-studies}
...
### <span class="header-section-number">2.7.2</span> Cross-sectionele surveys
...
1.  Met “nauwkeurig” wordt hier bedoeld dat de onderzoeksvraag zuiver kan beantwoord worden (bvb. dat het zuivere interventie-effect uit de gegevens kan gehaald worden). Dit wordt meer concreet in Hoofdstuk {chap:sample} uitgelegd. Voorlopig volstaat de intuïtieve betekenis van het woord. antwoord op de gestelde onderzoeksvraag te bepalen.[↩](index.md)
