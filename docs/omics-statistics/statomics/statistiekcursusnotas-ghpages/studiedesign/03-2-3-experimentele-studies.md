---
title: 2.3 Experimentele studies
...
<span id="def:unnamed-chunk-2" class="definition">**Definitie 2.1 (experiment)** </span>Een **experiment** is een reeks observaties die gemaakt worden onder condities die gecontroleerd worden door de onderzoeker. De onderzoeker controleert hierbij verschillende factoren (zoals de keuze van de interventie voor een locatie, plant, dier), met als doel een nauwkeurig.<a href="#fn4" id="fnref4" class="footnoteRef"><sup>4</sup></a>

Bijvoorbeeld, wanneer een dierenfysioloog 2 behandelingen wenst te vergelijken tussen experimentele dieren, dan kan hij - zoals we in dit hoofdstuk zullen zien - vermijden dat het behandelingseffect vertekend<a href="#fn5" id="fnref5" class="footnoteRef"><sup>5</sup></a> is door vergelijkbare groepen dieren te creëren; bijvoorbeeld, door lukraak (bijvoorbeeld door het opgooien van een muntstuk) te bepalen welke behandeling aan welk dier wordt toegediend.

### <span class="header-section-number">2.3.1</span> De Salk Vaccin Veldstudie
...
1.  Ten eerste zou het kunnen dat men door toeval een verschil in incidentie waarneemt tussen beide groepen, doordat er per toeval bijvoorbeeld relatief gezien minder kinderen in de gevaccineerde groep polio ontwikkelen. In Hoofdstuk [4](../chap-besluit/index.md) zullen we methoden aanleren om uit te maken of een geobserveerd vaccinatie-effect (d.w.z. een vaccinatie-effect dat geschat of berekend werd o.b.v. de gegevens) al dan niet toevallig is.
...
<span id="exm:unnamed-chunk-4" class="example">**Voorbeeld 2.1 (De nood aan controle)** </span>
...
<span id="tab:dbrcStudy">Tabel 2.2: </span>De gerandomiseerd gecontroleerde studie: aantal kinderen en incidentie (uitgedrukt per 100000 kinderen per jaar).

### <span class="header-section-number">2.3.2</span> Gerandomiseerd gecontroleerde studies
...
<span id="def:unnamed-chunk-8" class="definition">**Definitie 2.5 (systematische allocatie)** </span>**Systematische allocatie** of **louter toevallige allocatie** *(in het Engels: haphazard allocation)* is een toewijzingsmethode die mogelijks op een lukraak mechanisme lijkt, maar waarbij men de toewijzing van (sommige) subjecten op voorhand kan voorspellen.
...
<span id="exm:unnamed-chunk-9" class="example">**Voorbeeld 2.3 (Confounding in mariene veldexperimenten, vervolg)** </span>
...
<span id="def:unnamed-chunk-10" class="definition">**Definitie 2.6 (gestratificeerde randomisatie)** </span>**Gestratificeerde randomisatie** *(in het Engels: stratified randomisation)* is een gebalanceerde randomisatie die afzonderlijk wordt uitgevoerd per groep subjecten met gelijkaardige prognostische factoren<a href="#fn7" id="fnref7" class="footnoteRef"><sup>7</sup></a> (bvb. afzonderlijk op plaatsen dicht versus ver van de kust). Ze wordt gebruikt om te voorkomen dat die prognostische factoren door toeval niet gelijk verdeeld zouden zijn over de verschillende interventiegroepen en als gevolg daarvan, net zoals confounders, een storende invloed zouden hebben op de associatie tussen behandeling en respons.

**Einde definitie**

*Randomized complete block designs* zijn experimentele designs waarbij men eerst de experimentele subjecten opdeelt in blokken en vervolgens elk niveau van de interventie binnen elk blok toepast en via randomisatie toewijst. Men kan dit realiseren d.m.v. gestratificeerde randomisatie waarbij de stratificatie volgens blokken verloopt. Dergelijke designs worden vaak gebruikt wanneer biologische processen worden bestudeerd, vooral wanneer de uitkomst zó sterk varieert tussen subjecten dat het interventie-effect moeilijk op te pikken is vantussen de vele ruis op de gegevens. Als de gegevens veel minder variabel zijn per blok, laat het randomiseren van de interventie per blok immers toe om het interventie-effect per blok te evalueren met veel minder ruis<a href="#fn8" id="fnref8" class="footnoteRef"><sup>8</sup></a>. In de biologische wetenschappen stellen blokken vaak experimentele subjecten voor die gelijkaardig zijn in tijd of ruimte, hoewel men ook organismen van dezelfde leeftijd, grootte, … kan beschouwen.
...
### <span class="header-section-number">2.3.5</span> Factoriële designs {#factoriële-designs}
...
<span id="def:unnamed-chunk-16" class="definition">**Definitie 2.7 (interactie of effect-modificatie)** </span>Een **interactie** tussen 2 interventies drukt uit dat een combinatie van 2 interventies een effect heeft dat groter of kleiner is dan de som van de effecten van de afzonderlijke interventies (op een zekere schaal).

<span id="exm:unnamed-chunk-17" class="example">**Voorbeeld 2.9 (Grootte van salamanderlarven)** </span>
...
<span id="exm:unnamed-chunk-18" class="example">**Voorbeeld 2.10 (Groei van esdoorn versus beuk)** </span>
...
### <span class="header-section-number">2.3.6</span> Quasi-experimentele designs
...
<span id="exm:unnamed-chunk-19" class="example">**Voorbeeld 2.11 (Gezondheidscampagne in Wales)** </span>
...
[← 2.2 Steekproefdesigns {#steekproefdesigns}](02-2-2-steekproefdesigns-steekproefdesigns.md) · [Up: contents](index.md) · [2.4 Observationele studies {#observationele-studies} →](04-2-4-observationele-studies-observationele-studies.md)
