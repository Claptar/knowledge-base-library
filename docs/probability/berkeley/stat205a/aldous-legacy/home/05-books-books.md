...
**R. Durrett** [*Probability: Theory and Examples (4th edition)*](http://www.amazon.com/Probability-Cambridge-Statistical-Probabilistic-Mathematics/dp/0521765390) is the required text, and the single most relevant text for the whole year's course. The style is deliberately concise. Quite a few of the homework problems are from there,
...
[← Prerequisites {#prerequisites}](04-prerequisites-prerequisites.md) · [Up: contents](index.md) · [HOMEWORK {#homework} →](06-homework-homework.md)
