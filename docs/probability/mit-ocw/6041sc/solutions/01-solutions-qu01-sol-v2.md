---
title: 01 solutions qu01 sol v2
source: https://ocw.mit.edu/courses/6-041sc-probabilistic-systems-analysis-and-applied-probability-fall-2013/
source_file: sources/ocw-6041sc/solutions/01-solutions-qu01-sol-v2.pdf
...
# 01 solutions qu01 sol v2

**Source:** `solutions/01-solutions-qu01-sol-v2.pdf` from [ocw-6041sc](https://ocw.mit.edu/courses/6-041sc-probabilistic-systems-analysis-and-applied-probability-fall-2013/) · **Licence:** CC BY-NC-SA 4.0 · Converted 2026-09-14 from `.pdf` (lossy)
...
Since adding or subtracting a constant from a random variable has no e ect on its variance, and since X1 and X2 are independent, we have


## (c) (12 points)

Let k ≥ 0 and ℓ ≥ k. The event “Y1 = k and Y2 = ℓ” is identical to the event “X1 = k + 1 and X2 = ℓ − k + 1”. Since X1 and X2 are independent, the desired probability is (1 − g)g<sup>k+1</sup><sup>`−`1</sup> (1 − g)gℓ `−` k+1 `−` 1 = (1 − g)<sup>2</sup> gℓ, when 0 ≤ k ≤ ℓ, and zero otherwise.
