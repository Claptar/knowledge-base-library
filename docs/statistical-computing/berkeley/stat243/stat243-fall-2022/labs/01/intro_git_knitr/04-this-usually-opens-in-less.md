---
title: this usually opens in less
...
[← the URL / clone method (HTTPS or SSH) for your new repo](03-the-url-clone-method-https-or-ssh-for-your-new-repo.md) · [Up: contents](index.md) · [type Q to quit and return to the bash shell →](05-type-q-to-quit-and-return-to-the-bash-shell.md)
