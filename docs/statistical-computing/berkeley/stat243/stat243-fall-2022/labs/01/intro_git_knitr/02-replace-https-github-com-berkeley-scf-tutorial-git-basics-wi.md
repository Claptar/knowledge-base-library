---
title: replace https://github.com/berkeley-scf/tutorial-git-basics with
...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [the URL / clone method (HTTPS or SSH) for your new repo →](03-the-url-clone-method-https-or-ssh-for-your-new-repo.md)
