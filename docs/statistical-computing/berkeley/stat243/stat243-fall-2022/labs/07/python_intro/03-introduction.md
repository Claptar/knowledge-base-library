...
[← or to install within your home directory if you do not have admin control of the computer](02-or-to-install-within-your-home-directory-if-you-do-not-have.md) · [Up: contents](index.md) · [be careful - if you try 2/3 in Python 2, you'll get different behavior. →](04-be-careful---if-you-try-2-3-in-python-2-you-ll-get-different.md)
