---
title: (assuming that your working directory is "sections/03/")
...
[← different expected type](09-different-expected-type.md) · [Up: contents](index.md) · [run from R console →](11-run-from-r-console.md)
