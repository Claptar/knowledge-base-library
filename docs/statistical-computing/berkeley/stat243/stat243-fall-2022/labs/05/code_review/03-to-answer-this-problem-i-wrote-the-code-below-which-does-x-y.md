---
title: To answer this problem, I wrote the code below which does x, y, and z...
...
[← General notes about homeworks](02-general-notes-about-homeworks.md) · [Up: contents](index.md) · [and this comment should instead be in the text above the code chunk :( →](04-and-this-comment-should-instead-be-in-the-text-above-the-cod.md)
