...
3.  Answers should consist of textual response or mathematical
    ...
    solution.** Please see our [qualitative grading rubric](https://github.com/berkeley-stat243/stat243-fall-2022/blob/34dee34760386ed7a0ea4f1fd1c9e7d088e637ff/rubric) for guidance.
...
In the first section (September 2), we'll discuss [how to submit your problem sets](https://github.com/berkeley-stat243/stat243-fall-2022/blob/34dee34760386ed7a0ea4f1fd1c9e7d088e637ff/howtos/ps-submission) both on Gradescope and via your class GitHub repository, located at `https://github.berkeley.edu/<your_calnet_username>`.
...
Again, the [qualitative grading rubric](https://github.com/berkeley-stat243/stat243-fall-2022/blob/34dee34760386ed7a0ea4f1fd1c9e7d088e637ff/rubric) provides guidance
...
[← Class time {#class-time .unnumbered}](10-class-time-class-time-unnumbered.md) · [Up: contents](index.md) · [Feedback {#feedback .unnumbered} →](12-feedback-feedback-unnumbered.md)
