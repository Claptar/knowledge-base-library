...
[← You will need to set the following variables with your](06-you-will-need-to-set-the-following-variables-with-your.md) · [Up: contents](index.md) · [a personal account on Twitter (if you don't already have →](08-a-personal-account-on-twitter-if-you-don-t-already-have.md)
