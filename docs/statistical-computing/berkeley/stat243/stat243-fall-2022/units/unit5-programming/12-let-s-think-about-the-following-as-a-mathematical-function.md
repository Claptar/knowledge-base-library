---
title: let's think about the following as a mathematical function
...
[← 7. Functional programming](11-7-functional-programming.md) · [Up: contents](index.md) · [-- what's the function call? →](13----what-s-the-function-call.md)
