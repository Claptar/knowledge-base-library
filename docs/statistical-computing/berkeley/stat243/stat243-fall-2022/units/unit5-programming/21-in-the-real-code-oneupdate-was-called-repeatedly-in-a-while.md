---
title: in the real code, oneUpdate was called repeatedly in a while loop as
...
[← do single update](20-do-single-update.md) · [Up: contents](index.md) · [part of an iterative optimization to find a maximum likelihood estimator →](22-part-of-an-iterative-optimization-to-find-a-maximum-likeliho.md)
