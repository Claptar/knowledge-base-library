---
title: not clear if should repartition; will likely have small partitions if not
...
[← watch the UI and watch wwall as computation progresses](11-watch-the-ui-and-watch-wwall-as-computation-progresses.md) · [Up: contents](index.md) · [Unit 07 — bigData Part 13 — →](13-unit-07-bigdata-part-13.md)
