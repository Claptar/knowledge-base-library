---
title: personal information. To do this you will need to create
...
[← You will need to set the following variables with your](12-you-will-need-to-set-the-following-variables-with-your.md) · [Up: contents](index.md) · [a personal account on Twitter (if you don't already have →](14-a-personal-account-on-twitter-if-you-don-t-already-have.md)
