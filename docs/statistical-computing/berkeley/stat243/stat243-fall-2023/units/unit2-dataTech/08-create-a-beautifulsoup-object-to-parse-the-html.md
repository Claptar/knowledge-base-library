...
[← 4. Webscraping and working with HTML, XML, and JSON](07-4-webscraping-and-working-with-html-xml-and-json.md) · [Up: contents](index.md) · [help(bs.findall) →](09-help-bs-findall.md)
