---
title: 2. MapReduce, Dask, Hadoop, and Spark
...
[← 1. A few preparatory notes](02-1-a-few-preparatory-notes.md) · [Up: contents](index.md) · [specify some dtypes so Pandas doesn't complain about column type heterogeneity →](04-specify-some-dtypes-so-pandas-doesn-t-complain-about-column.md)
