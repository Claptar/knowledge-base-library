...
[← x = da.fromarray(x, chunks=(2500, 40000)) # adjust chunk size of existing array](06-x-da-fromarray-x-chunks-2500-40000-adjust-chunk-size-of-exis.md) · [Up: contents](index.md) · [3. Databases →](08-3-databases.md)
