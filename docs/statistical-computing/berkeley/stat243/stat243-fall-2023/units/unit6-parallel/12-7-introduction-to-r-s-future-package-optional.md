...
[← specify dtypes so Pandas doesn't complain about column type heterogeneity](11-specify-dtypes-so-pandas-doesn-t-complain-about-column-type.md) · [Up: contents](index.md) · [alternatively, one can also control number of workers →](13-alternatively-one-can-also-control-number-of-workers.md)
