---
title: transfer to my home directory without renaming the file
...
[← Your ~/ on the SCF](03-your-on-the-scf.md) · [Up: contents](index.md) · [transfer to the data/ subdirectory and rename the file →](05-transfer-to-the-data-subdirectory-and-rename-the-file.md)
