...
1. Your electronic solution should be in the form of an R markdown file named _ps2.Rmd_ or a L<sup>A</sup> TEX+knitr file named _ps2.Rnw_ or _ps2.Rtex_ , with bash and R code chunks included in the file (or read in from a separate code file).

2. Your PDF submission should be the PDF produced from your Rmd/Rtex/Rnw. Your Github submission should include the Rtex/Rmd/Rnw file, any code files containing chunks that you read into your Rtex/Rmd file, and the final PDF, all named according to the guidelines in _howtos/submittingelectronically.txt_ .
