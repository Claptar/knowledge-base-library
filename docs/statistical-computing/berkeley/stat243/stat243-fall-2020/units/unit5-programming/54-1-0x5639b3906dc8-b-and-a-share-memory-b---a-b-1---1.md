---
title: '[1] "<0x5639b3906dc8>" ## b and a share memory b <- a b[1] <- 1'
...
# [1] "<0x5639b3906dc8>" ## b and a share memory b <- a b[1] <- 1
...
[← Unit 05 — programming Part 53 —](53-unit-05-programming-part-53.md) · [Up: contents](index.md) · [Unit 05 — programming Part 55 — →](55-unit-05-programming-part-55.md)
