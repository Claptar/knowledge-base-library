...
**system** ("ls -al") _## knitr/Sweave doesn't seem to show the output of system()_ files <- **system** ("ls", intern = TRUE) files[1:5] ## [1] "badCode.R" "cache" ## [3] "class1-demo.sh" "class2-taboo-game.md" ## [5] "class-regex.R"
...
**list.files** ( **file.path** ("..", "data")) ## [1] "coop.txt.gz" "cpds.csv" ## [3] "hivSequ.csv" "IPs.RData" ## [5] "precip.txt" "precipData.txt" ## [7] "RTADataSub.csv" "stackoverflow-2016.db"
...
_## options() # this would print out a long list of options_ **options** ()[1:5] ## $add.smooth ## [1] TRUE ## ## $bitmapType ## [1] "cairo" ## ## $browser ## [1] "xdg-open"
