...
Please see the material in our tutorial on the _basics of UNIX_ to get up to speed on working in a UNIX-style command line environment. We’ll do a bit of demo in the first class. If what you see seems quite familiar, you can probably skip that tutorial. If what you see is not familiar, please work through the tutorial and (optionally) attend section on Friday August 28 to work in groups on the problems at the end of the tutorial.
