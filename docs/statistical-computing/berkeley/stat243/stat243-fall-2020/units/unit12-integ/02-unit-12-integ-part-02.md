...
## [1] 1.98567063 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.002 0.000 0.003 n <- 10000 **ninteg** (n) ## [1] 1.99362722 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.001 0.000 0.001 n <- 1000000 **ninteg** (n) ## [1] 2.00094071 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.054 0.000 0.054 _## that was fairly slow, ## especially if you need to do a lot of individual integrals_
