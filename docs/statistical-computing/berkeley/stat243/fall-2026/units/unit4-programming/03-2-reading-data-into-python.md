...
[← 1. Text manipulation, string processing and regular expressions (regex)](02-1-text-manipulation-string-processing-and-regular-expression.md) · [Up: contents](index.md) · [output is a sequence of bytes. →](04-output-is-a-sequence-of-bytes.md)
