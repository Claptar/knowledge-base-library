...
[scopes and namespaces](23-syntaxerror-positional-argument-follows-keyword-argument.md#namespaces-and-scopes) in more detail later.
...
[← 4. Interacting with the operating system and external code and configuring Python](07-4-interacting-with-the-operating-system-and-external-code-an.md) · [Up: contents](index.md) · [6. Types and data structures →](09-6-types-and-data-structures.md)
