...
[← functional, but using class methods](14-functional-but-using-class-methods.md) · [Up: contents](index.md) · [8. Object-oriented programming (OOP) →](16-8-object-oriented-programming-oop.md)
