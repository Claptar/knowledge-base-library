...
part to [disk caching by the operating system](https://github.com/berkeley-stat243/fall-2026/blob/c74395ec9c420005c80bbcc5f315729aaee3dc32/units/unit5-programming.html#monitoring-overall-memory-use-on-a-unix-style-computer) as well as careful
...
[← For some reason the fromarray and da.mean calculations are not done lazily here.](06-for-some-reason-the-fromarray-and-da-mean-calculations-are-n.md) · [Up: contents](index.md) · [Unit 05 — bigData Part 08 — →](08-unit-05-bigdata-part-08.md)
