...
[← not clear how to sort by start time](11-not-clear-how-to-sort-by-start-time.md) · [Up: contents](index.md) · [5. Data storage and file formats on a computer →](13-5-data-storage-and-file-formats-on-a-computer.md)
