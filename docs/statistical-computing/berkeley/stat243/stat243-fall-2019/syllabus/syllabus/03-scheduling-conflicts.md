...
More specifically, I anticipate the exam will be the week of November 11, so if you expect to be gone during that week, we’ll need to discuss that.

---

[← Accomodations for Students with Disabilities](02-accomodations-for-students-with-disabilities.md) · [Up: contents](index.md) · [Campus Honor Code →](04-campus-honor-code.md)
