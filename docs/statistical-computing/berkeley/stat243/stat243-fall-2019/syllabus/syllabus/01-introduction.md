...
# STAT 243: Introduction to Statistical Computing Fall 2019 (Paciorek)
...
email: jared_bennett@berkeley.edu
...
- Github for course content: https://github.com/berkeley-stat243/stat243-fall-2019, including logistics info on the main Github page (scroll down below the files listing).

- bCourses site for online course discussion, announcements and Q&A: https://bcourses.berkeley.edu/courses/1484436.

- SCF tutorials for additional content: https://statistics.berkeley.edu/computing/training/tutorials

All course materials will be posted on Github. Class will follow a set of course notes with demonstrations. I will do my best to post the slides and demo code for class by 6 pm the day before class. I will not print out copies, so please bring your own copies if you want them in front of you. Note that each unit will have a single set of notes and demo code that I will add to as we move through the unit, so you may want to just print out the new pages. I’ll provide PDF documents as well as the underlying LYX file I used to generate the document. If you want a plain L<sup>A</sup> TEX version, open the LYX file in LYX and do File->Export->L<sup>A</sup> TEX(pdflatex). For some material, we will make use of tutorials provided by the SCF.

We will use the bCourses site for communication (announcements, questions, and discussion). You should ask questions about class material and problem sets through the bCourses website. Please use this site for your questions so that either Jared or I can respond and so that everyone can benefit from the discussion. I suggest you to modify your settings on bCourses so you are informed by email of postings. I strongly encourage you to respond to or comment on each other’s questions as well (this will help your class participation grade), although of course you should not provide a solution to a problem set problem. If you have a specific administrative question you need to direct just to me, it’s fine to email me directly. But if you simply want to privately ask a question about content, then just come to an office hour or see me after class.

In addition, we will use bCourses for viewing grades and accessing the class screencasts. Apart from that, all other materials will be on Github.
...
Finally, screencasts will be available through the bCourses Course Capture feature, available on the Course Captures tab on the bCourses page for the class. Note that the screencasts will necessarily be more effective for the computer demos and will miss material that I write on the board.

### **Course requirements and grading**

#### **Course grades**

The grade for this course is primarily based on assignments due every 1-2 weeks, a short exam in November, and a final group project. I will also provide extra credit questions on some problem sets. There is no final exam. 50% of the grade is based on the problem sets, 25% on the exam, 15% on the project, and 10% on your participation in discussions on the bCourses site, your responses to the in-class Google forms questions, as well as occasional brief questions that I will ask you to answer in advance of the next class.
...
**On-time submission will be determined based on the time stamp of when the PDF is submitted to bCourses.**
