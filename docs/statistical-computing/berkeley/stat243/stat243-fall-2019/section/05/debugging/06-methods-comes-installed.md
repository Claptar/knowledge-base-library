...
[← jackknife gamma dist. estimates of cat heart weights](05-jackknife-gamma-dist-estimates-of-cat-heart-weights.md) · [Up: contents](index.md) · [unless you're running Rscript, then idk →](07-unless-you-re-running-rscript-then-idk.md)
