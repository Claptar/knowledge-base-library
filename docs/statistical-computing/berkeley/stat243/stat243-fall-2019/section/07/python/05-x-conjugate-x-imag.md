...
[← x.asintegerratio x.hex x.real](04-x-asintegerratio-x-hex-x-real.md) · [Up: contents](index.md) · [x.fromhex x.isinteger →](06-x-fromhex-x-isinteger.md)
