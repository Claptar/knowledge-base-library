...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [explicit about namespace so you know where these functions are coming from. →](03-explicit-about-namespace-so-you-know-where-these-functions-a.md)
