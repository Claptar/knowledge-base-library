...
[← explicit about namespace so you know where these functions are coming from.](03-explicit-about-namespace-so-you-know-where-these-functions-a.md) · [Up: contents](index.md) · [safer way →](05-safer-way.md)
