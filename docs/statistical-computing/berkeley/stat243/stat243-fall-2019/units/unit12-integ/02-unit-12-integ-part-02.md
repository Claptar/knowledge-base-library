---
title: Unit 12 — integ Part 02 —
source: https://github.com/berkeley-stat243/stat243-fall-2019/blob/b2795324dec367a50f578b01c67d907994ff40f5/units/unit12-integ.pdf
source_file: sources/berkeley-stat243/stat243-fall-2019/units/unit12-integ.pdf
licence: unresolved
route: pdf
fidelity: lossy
...
# Unit 12 — integ Part 02 —

**Source:** [`units/unit12-integ.pdf`](https://github.com/berkeley-stat243/stat243-fall-2019/blob/b2795324dec367a50f578b01c67d907994ff40f5/units/unit12-integ.pdf) · **Licence:** unresolved · Converted 2026-09-14 from `.pdf` (lossy)
...
## user system elapsed ## 0 0 0 _## MC estimate_ ninteg <- **function** (n) **mean** ( **sin** ( **runif** (n, 0, pi))*pi) n <- 1000 **ninteg** (n)

7

## [1] 1.95939306 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.004 0.000 0.002 n <- 10000 **ninteg** (n) ## [1] 1.99683696 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.004 0.000 0.001 n <- 1000000 **ninteg** (n) ## [1] 2.00097819 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.112 0.000 0.112 _## that was fairly slow, ## especially if you need to do a lot of individual integrals_
...
- # one-dimensional integration Integrate[Sin[x]^2, x]

- # two-dimensional integration Integrate[Sin[x] Exp[-y^2], x, y]

13

---

[← Unit 12: Numerical Integration and Differentiation](01-unit-12-numerical-integration-and-differentiation.md) · [Up: contents](index.md)
