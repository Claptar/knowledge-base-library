---
title: '[14] "/usr/lib/R/library/base"'
...
Note that R will generally install the package in a reasonable place if you omit the _lib_ argument.

8

You can also download the zipped source file from CRAN and install from the file; see the help page for _install.packages()_ . This is called “installing from source”. On Windows and Mac, you’ll need to do something like this:
...
[← [13] "Autoloads"](13-13-autoloads.md) · [Up: contents](index.md) · [Unit 05 — programming Part 15 — →](15-unit-05-programming-part-15.md)
