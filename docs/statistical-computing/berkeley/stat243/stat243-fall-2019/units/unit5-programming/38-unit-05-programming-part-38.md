...
[← $x ## ## ## $y ## [1] 2 ## ## $z ## 3/y class ( formals (f)) ## [1] "pairlist"](37-y-1-2-z-3-y-class-formals-f-1-pairlist.md) · [Up: contents](index.md) · [Unit 05 — programming Part 39 — →](39-unit-05-programming-part-39.md)
