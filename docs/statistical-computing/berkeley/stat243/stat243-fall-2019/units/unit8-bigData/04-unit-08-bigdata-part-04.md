...
On Savio, to view the interfaces in a web browser, you need to start a remote desktop (VNC) session, following these instructions: https://research-it.berkeley.edu/services/high-performancecomputing/using-brc-visualization-node-realvnc; I suggest using the VNC add-on to the Chrome
...
def findShortLines(line): vals = line.split(' ')

11

if len(vals) < 6: return(False) else: return(True)
...
[← Unit 08 — bigData Part 03 —](03-unit-08-bigdata-part-03.md) · [Up: contents](index.md) · [Unit 08 — bigData Part 05 — →](05-unit-08-bigdata-part-05.md)
