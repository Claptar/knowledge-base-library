...
2. Or in Python, you may be able to use the iPython Notebook, now known as Jupyter, which supports code chunks in dozens of languages.

3. You might consider using the UNIX utility _make_ , which is generally used for compiling code, as a tool for reproducible research: see the tutorial on _Using make for workflows_ for more details.
