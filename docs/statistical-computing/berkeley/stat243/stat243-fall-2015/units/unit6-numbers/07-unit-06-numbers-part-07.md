...
_Floating point_ refers to the decimal point (or radix point since we’ll be working with base 2 and _decimal_ relates to 10). Consider Avogadro’s number in terms of scientific notation: +6 _._ 023 _×_ 10<sup>23</sup> .
...
[← 2 Floating point basics](06-2-floating-point-basics.md) · [Up: contents](index.md) · [Unit 06 — numbers Part 08 — →](08-unit-06-numbers-part-08.md)
