...
We might denote the data, which could be the statistical estimator under each of two methods as _Yijklq_ , where _i_ indexes treatment, _j, k, l_ index different additional input variables, and _q ∈_

14

_{_ 1 _, . . . , m}_ indexes the replicate. E.g., _j_ might index whether the data are from a t or normal, _k_ the value of a parameter, and _l_ the dataset sample size (i.e., different levels of _n_ ).
...
G<br>G<br>G<br>G GG G GGGGG G GGG G G GGGG GGG G GGG GGG GGG GG GG G GGG GG G  G G GGG GGG<br>G<br>G<br>G<br>−2 −1 0 1 2<br>60<br>tdevs 20<br>−20<br><!-- End of picture text -->
