...
library) is specified by the output of _.libPaths()_ . If none of them are user-owned, you may need to add a library via .libPaths() (e.g., by putting something like .libPaths(’~/Rlibs’) in your _.Rprofile_ ).

**<mark>install.packages</mark>** <mark>('fields', lib = '~/Rlibs')</mark> _<mark># ~/Rlibs needs to exi</mark> st!_
...
[← [15] "Autoloads"](11-15-autoloads.md) · [Up: contents](index.md) · [Unit 04 — programming Part 13 — →](13-unit-04-programming-part-13.md)
