...
[← 2 Reading data from text files into R](02-2-reading-data-from-text-files-into-r.md) · [Up: contents](index.md) · [Unit 03 — Rinput Part 04 — →](04-unit-03-rinput-part-04.md)
