...
source: https://github.com/berkeley-stat243/stat243-fall-2015/blob/ee3c3c2c523a96eefceddf8703d4938396730993/units/unit12-integ.pdf
source_file: sources/berkeley-stat243/stat243-fall-2015/units/unit12-integ.pdf
licence: unresolved
route: pdf
fidelity: lossy
...
**Source:** [`units/unit12-integ.pdf`](https://github.com/berkeley-stat243/stat243-fall-2015/blob/ee3c3c2c523a96eefceddf8703d4938396730993/units/unit12-integ.pdf) · **Licence:** unresolved · Converted 2026-09-14 from `.pdf` (lossy)
...
## user system elapsed ## 0 0 0 _## MC estimate_

ninteg <- **function** (n) **mean** ( **sin** ( **runif** (n, 0, pi))*pi) n <- 1000 **ninteg** (n)

7

## [1] 2.00395567 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.000 0.000 0.001 n <- 10000 **ninteg** (n) ## [1] 1.99124227 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.000 0.000 0.001 n <- 1000000 **ninteg** (n) ## [1] 1.99806638 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.062 0.001 0.062 _## that was fairly slow, ## especially if you need to do a lot of individual integrals_
