...
[← check files on the HDFS, e.g.: hadoop fs -ls /data/airline](15-check-files-on-the-hdfs-e-g-hadoop-fs--ls-data-airline.md) · [Up: contents](index.md) · [Unit 07 — bigData Part 17 — →](17-unit-07-bigdata-part-17.md)
