---
title: 'check files on the HDFS, e.g.: hadoop fs -ls /data/airline'
...
# check files on the HDFS, e.g.: hadoop fs -ls /data/airline
...
[← wget http://www.stat.berkeley.edu/share/paciorek/1987.csv.bz2](14-wget-http-www-stat-berkeley-edu-share-paciorek-1987-csv-bz2.md) · [Up: contents](index.md) · [get numpy installed →](16-get-numpy-installed.md)
