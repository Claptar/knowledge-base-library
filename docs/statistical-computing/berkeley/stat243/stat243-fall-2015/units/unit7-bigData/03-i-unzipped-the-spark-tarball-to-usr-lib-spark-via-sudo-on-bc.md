---
title: I unzipped the Spark tarball to /usr/lib/spark via sudo on BCE cd /usr/lib/spark/ec2
...
# I unzipped the Spark tarball to /usr/lib/spark via sudo on BCE cd /usr/lib/spark/ec2
...
[← Unit 07 — bigData Part 02 —](02-unit-07-bigdata-part-02.md) · [Up: contents](index.md) · [Unit 07 — bigData Part 04 — →](04-unit-07-bigdata-part-04.md)
