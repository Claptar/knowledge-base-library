...
[← We can view system status through a web browser interface](08-we-can-view-system-status-through-a-web-browser-interface.md) · [Up: contents](index.md) · [Unit 07 — bigData Part 10 — →](10-unit-07-bigdata-part-10.md)
