...
**<mark>install.packages</mark>** <mark>('dplyr', lib = '~/Rlibs') # ~/Rlibs needs to exis</mark> t!
...
[← [11] "Autoloads"](11-11-autoloads.md) · [Up: contents](index.md) · [Unit 04 — programming partial Part 13 — →](13-unit-04-programming-partial-part-13.md)
