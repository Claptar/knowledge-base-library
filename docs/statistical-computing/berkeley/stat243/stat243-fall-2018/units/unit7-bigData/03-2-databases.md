...
You can view one reasonable schema in the file _normalized_example.png_ . The lines between tables indicate the relationship of foreign keys in one table to primary keys in another table. The
...
|_# s_|_imple query _|_to get 5 rows from a _|_table_|||
|---|---|---|---|---|---|
|**dbG**|**etQuery**(db,|"select * from quest|ions limit|5")||
...
|##|5<br>34552555|2016-01-01 00:00:51|-1|54||
|##||||||
|##|1||||Scope b|
...
[← 1 A few preparatory notes](02-1-a-few-preparatory-notes.md) · [Up: contents](index.md) · [ownerid ## 1 5684416 ## 2 2457617 ## 3 5732525 ## 4 5735112 ## 5 4646288 →](04-ownerid-1-5684416-2-2457617-3-5732525-4-5735112-5-4646288.md)
