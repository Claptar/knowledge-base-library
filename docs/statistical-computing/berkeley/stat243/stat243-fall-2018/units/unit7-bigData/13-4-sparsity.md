...
[← 3 R and big data](12-3-r-and-big-data.md) · [Up: contents](index.md) · [5 Using statistical concepts to deal with computational bottlenecks →](14-5-using-statistical-concepts-to-deal-with-computational-bott.md)
