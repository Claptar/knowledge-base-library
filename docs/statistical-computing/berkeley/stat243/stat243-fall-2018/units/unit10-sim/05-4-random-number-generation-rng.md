...
n <- 100 a <- 171 m <- 30269 u <- **rep** (NA, n) u[1] <- 7306 **for** (i **in** 2:n) u[i] <- (a * u[i-1]) %% m u <- u/m uFromR <- **runif** (n) **par** (mfrow = **c** (2,2)) **plot** (1:n, u, type = 'l') **plot** (1:n, uFromR, type = 'l') **hist** (u, nclass = 25)

11

**<mark>hist</mark>** <mark>(uFromR, nclass = 25)</mark>
