...
[← Unit 04 — programming Part 37 —](37-unit-04-programming-part-37.md) · [Up: contents](index.md) · [%% is modulo operator - it gives the remainder →](39-is-modulo-operator---it-gives-the-remainder.md)
