...
**system** ("ls -al") _## knitr/Sweave doesn't seem to show the output of system()_ files <- **system** ("ls", intern = TRUE) files[1:5] ## [1] "badCode.R" "cache" ## [3] "class1_shell_history.sh" "class2.log" ## [5] "class2_shell_history.sh"
