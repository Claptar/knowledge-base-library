...
summary ## function (object, ...) ## UseMethod("summary") ## <bytecode: 0x53d4b90> ## <environment: namespace:base>

**methods** (summary)

---

[← $names ## [1] "x" "y" ## ## $row.names ## [1] 1 2 ## ## $class ## [1] "data.frame"](17-row-names-1-1-2-class-1-data-frame.md) · [Up: contents](index.md) · [Unit 04 — programming Part 19 — →](19-unit-04-programming-part-19.md)
