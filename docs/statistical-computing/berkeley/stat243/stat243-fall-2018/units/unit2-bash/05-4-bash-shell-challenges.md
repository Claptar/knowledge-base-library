...
Consider the file _unit2-bash.sh_ . How would you write a shell command that returns "There are 2 occurrences of the word ’bash’ in this file."
...
While R would be able to handle this using ‘read.table()‘, using _cut_ in UNIX won’t work because of the commas embedded within the fields. The challenge is to convert this file to one that we can use _cut_ on, as follows.
...
[← 3 bash shell examples](04-3-bash-shell-examples.md) · [Up: contents](index.md)
