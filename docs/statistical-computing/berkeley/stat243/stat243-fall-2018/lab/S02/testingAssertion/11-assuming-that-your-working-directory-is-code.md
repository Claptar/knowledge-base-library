---
title: (assuming that your working directory is "code/")
...
[← context with one test that groups expectations](10-context-with-one-test-that-groups-expectations.md) · [Up: contents](index.md) · [run from R console →](12-run-from-r-console.md)
