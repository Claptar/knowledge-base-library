...
[← Number of tasks needed for use case (example)](27-number-of-tasks-needed-for-use-case-example.md) · [Up: contents](index.md) · [Wall clock limit →](29-wall-clock-limit.md)
