...
The careful choice of _φ_ allows us to narrow the search interval by an equal proportion,1 _− φ_ , in each iteration. Eventually we have narrowed the minimum to between _xt−_ 1 and _xt_ , where the difference _|xt − xt−_ 1 _|_ is sufficiently small (within some tolerance - see Section 4 for details), and we report ( _xt_ + _xt−_ 1) _/_ 2.
