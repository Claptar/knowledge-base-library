...
animals[4] <- 'mouse' _# reset things to original state_ **eval** (out3) ## [1] "cat" "dog" "rat" "rat" animals _# both do the same thing_ ## [1] "cat" "dog" "rat" "mouse"
...
[← Unit 05 — programming Part 56 —](56-unit-05-programming-part-56.md) · [Up: contents](index.md) · [Unit 05 — programming Part 58 — →](58-unit-05-programming-part-58.md)
