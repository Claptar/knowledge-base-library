---
title: Unit 02 — dataTech Part 05 —
...
# get all the senators' timelines names = [d["screen_name"] for d in senators["users"]] timelines = [api.statuses.user_timeline(screen_name=name, count = 500) for name in names]

---

[← Unit 02 — dataTech Part 04 —](04-unit-02-datatech-part-04.md) · [Up: contents](index.md) · [Unit 02 — dataTech Part 06 — →](06-unit-02-datatech-part-06.md)
