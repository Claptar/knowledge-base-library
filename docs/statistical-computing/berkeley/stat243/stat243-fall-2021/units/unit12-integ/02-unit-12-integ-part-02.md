...
**Source:** [`units/unit12-integ.pdf`](https://github.com/berkeley-stat243/stat243-fall-2021/blob/c918dcc56a197cc539e270f1f7d076010b175c52/units/unit12-integ.pdf) · **Licence:** CC0-1.0 · Converted 2026-09-14 from `.pdf` (lossy)
...
## user system elapsed ## 0.001 0.000 0.001 _## MC estimate_

ninteg <- **function** (n) **mean** ( **sin** ( **runif** (n, 0, pi))*pi) n <- 1000 **ninteg** (n)

7

## [1] 2.02086145 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.002 0.000 0.003 n <- 10000 **ninteg** (n) ## [1] 2.00115929 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.001 0.000 0.000 n <- 1000000 **ninteg** (n) ## [1] 1.99795757 **system.time** ( **ninteg** (n)) ## user system elapsed ## 0.052 0.000 0.052 _## that was fairly slow, ## especially if you need to do a lot of individual integrals_
