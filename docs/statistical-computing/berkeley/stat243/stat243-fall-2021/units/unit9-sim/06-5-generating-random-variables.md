...
so _φ_<sup>ˆ</sup> = _m_<sup><u>1</u></sup> � _i_<sup>_h_(</sup><sup>_x_</sup> _i_<sup>)</sup><sup>_<u>f</u>_</sup> _g_ (<sup><u>(</u></sup> _x_<sup>_x_</sup> _i_<sup>_<u>i</u>_</sup> )<sup><u>)</u>for</sup><sup>_xi_drawn from</sup><sup>_g_(</sup><sup>_x_), where</sup><sup>_wi_=</sup><sup>_f_(</sup><sup>_xi_)</sup><sup>_/g_(</sup><sup>_xi_) act as weights.(Often in</sup> Bayesian contexts, we know _f_ ( _x_ ) only up to a normalizing constant. In this case we need to use _wi_<sup>_∗_=</sup><sup>_wi/_�</sup> _j_<sup>_w_</sup> _j_<sup>.</sup>
