...
> _r_<sup>_⊤_</sup> <u>(</u> _k_ <u>)</u><sup>_r_(</sup><sup>_k_)</sup> **–** _αk_ = _d_<sup>_⊤_</sup> _k_<sup>_Adk_(choosestepsizesonexterrorwillbeorthogonaltocurrentdirection-</sup> which we can express in terms of the residual, which is easily computable)
...
[← 6 Computation](13-6-computation.md) · [Up: contents](index.md)
