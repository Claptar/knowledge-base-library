...
**dg** (.1) ## [1] "0.10000000000000000555" **dg** (.5) ## [1] "0.50000000000000000000" **dg** (.25) ## [1] "0.25000000000000000000" **dg** (.26) ## [1] "0.26000000000000000888" **dg** (1/32) ## [1] "0.03125000000000000000" **dg** (1/33) ## [1] "0.03030303030303030387"
...
x <- 2^45 z <- 25 **class** (x) ## [1] "numeric" **class** (z) ## [1] "numeric" **as.integer** (x) ## Warning: NAs introduced by coercion to integer range ## [1] NA **as.integer** (z) ## [1] 25 1e308 ## [1] 1e+308 1e309 ## [1] Inf 2^31 ## [1] 2147483648 x <- 2147483647L x ## [1] 2147483647 **class** (x) ## [1] "integer" x <- 2147483648L **class** (x) ## [1] "numeric"
