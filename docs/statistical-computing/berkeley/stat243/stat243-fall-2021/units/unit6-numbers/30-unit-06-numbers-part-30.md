...
for _zk_ = _xβk_ . What will happen if the _z_ values are very large in magnitude (either positive or negative)? How can we reexpress the equation so as to be able to do the calculation? Hint: think about multiplying by<sup>_<u>c</u>_</sup> _c_<sup>for a carefully chosen</sup><sup>_c_.</sup>
...
[← Unit 06 — numbers Part 29 —](29-unit-06-numbers-part-29.md) · [Up: contents](index.md) · [Unit 06 — numbers Part 31 — →](31-unit-06-numbers-part-31.md)
