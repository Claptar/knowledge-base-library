---
title: x.asintegerratio x.hex x.real
...
[← be careful - if you try 2/3 in Python 2, you'll get different behavior.](03-be-careful---if-you-try-2-3-in-python-2-you-ll-get-different.md) · [Up: contents](index.md) · [x.conjugate x.imag →](05-x-conjugate-x-imag.md)
