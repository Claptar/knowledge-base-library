---
title: estimate standard error with our bootstrap function
...
[← note that the standard error for the regression coefficient is ~3](09-note-that-the-standard-error-for-the-regression-coefficient.md) · [Up: contents](index.md) · [note the overestimation of standard error 119 > 3 →](11-note-the-overestimation-of-standard-error-119-3.md)
