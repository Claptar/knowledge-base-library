---
title: The lifecycle approach to residential mobility
...
Determinants of residential mobility, such as household characteristics and their housing needs and expectations, change over time
...
In general, in the lifecycle approach, age is negatively associated with the probability of moving (Boehm and Ihlanfeld, 1986; Landale and Guest, 1985; Lee et al., 1994). Recent research has verified that this trend still holds (Beige and Axhausen, 2012; Clark et al., 2014; Coulter and van Ham, 2013;

4

Urban Studies

Wulff et al., 2010). This inverse relationship between the age factor and mobility has been one of the most consistent similarities among multiple residential mobility studies (Quigley and Weinberg, 1977). Simmons (1968), in a synthesis of mobility literature, concluded that of all moves within a lifecycle stage, about 20% occur for ages under 10, almost 60% happen between the ages of 10 and 40, and 20% after the age of 40 (Simmons, 1968).

---

[← Why families move](04-why-families-move.md) · [Up: contents](index.md) · [Application of a lifecycle-inspired approach in modelling household sorting patterns →](06-application-of-a-lifecycle-inspired-approach-in-modelling-ho.md)
