...
You can view [one reasonable schema](https://github.com/berkeley-stat243/fall-2024/blob/9c62305d05fca31df0d9c6a3b68b350ad8722fee/units/normalized_example.png).
...
[← For some reason the fromarray and da.mean calculations are not done lazily here.](06-for-some-reason-the-fromarray-and-da-mean-calculations-are-n.md) · [Up: contents](index.md) · [4. Recent tools and data storage formats →](08-4-recent-tools-and-data-storage-formats.md)
