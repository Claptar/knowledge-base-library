...
[← functional, but using class methods](11-functional-but-using-class-methods.md) · [Up: contents](index.md) · [6. Object-oriented programming (OOP) →](13-6-object-oriented-programming-oop.md)
