...
One real-world example of using decorators is in setting up functions to run in parallel in `dask`, which we'll discuss in Unit 7. Another is the use of Numba to do [just-in-time (JIT) compilation](25-9-efficiency.md#just-in-time-jit-compilation) of Python code.

---

[← for loop: needs storage set up and multiple lines](19-for-loop-needs-storage-set-up-and-multiple-lines.md) · [Up: contents](index.md) · [8. Memory and copies →](21-8-memory-and-copies.md)
