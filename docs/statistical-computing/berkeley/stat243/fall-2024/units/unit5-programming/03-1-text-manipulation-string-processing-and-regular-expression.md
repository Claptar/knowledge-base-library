...
```python
text = "Here's my number: 919-543-3300. They bought 731 bananas. Please call 919.554.3800."
re.sub("([0-9]{3})[-\.](https://github.com/berkeley-stat243/fall-2024/blob/9c62305d05fca31df0d9c6a3b68b350ad8722fee/units/[0-9]{3})[-\.](https://github.com/berkeley-stat243/fall-2024/blob/9c62305d05fca31df0d9c6a3b68b350ad8722fee/units/[0-9]{4})", "area code \\1, number \\2-\\3", text)
```
...
[← Overview](02-overview.md) · [Up: contents](index.md) · [2. Interacting with the operating system and external code and configuring Python →](04-2-interacting-with-the-operating-system-and-external-code-an.md)
