...
[← 1. Text manipulation, string processing and regular expressions (regex)](03-1-text-manipulation-string-processing-and-regular-expression.md) · [Up: contents](index.md) · [3. Modules and packages →](05-3-modules-and-packages.md)
