...
[← OOP: modify objects using class methods](12-oop-modify-objects-using-class-methods.md) · [Up: contents](index.md) · [7. Functional programming →](14-7-functional-programming.md)
