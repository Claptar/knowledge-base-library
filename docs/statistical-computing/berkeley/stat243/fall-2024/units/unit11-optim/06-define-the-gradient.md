...
[← Define the original function](05-define-the-original-function.md) · [Up: contents](index.md) · [Define the second derivative →](07-define-the-second-derivative.md)
