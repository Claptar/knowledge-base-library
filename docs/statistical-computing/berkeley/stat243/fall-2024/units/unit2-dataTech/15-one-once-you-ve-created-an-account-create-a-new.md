---
title: one). Once you've created an account, create a new
...
[← a personal account on Twitter (if you don't already have](14-a-personal-account-on-twitter-if-you-don-t-already-have.md) · [Up: contents](index.md) · [application here →](16-application-here.md)
