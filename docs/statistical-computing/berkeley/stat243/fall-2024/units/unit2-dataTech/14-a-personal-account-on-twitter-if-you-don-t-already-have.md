---
title: a personal account on Twitter (if you don't already have
...
[← personal information. To do this you will need to create](13-personal-information-to-do-this-you-will-need-to-create.md) · [Up: contents](index.md) · [one). Once you've created an account, create a new →](15-one-once-you-ve-created-an-account-create-a-new.md)
