...
[← 4. Webscraping and working with HTML, XML, JSON, and YAML](07-4-webscraping-and-working-with-html-xml-json-and-yaml.md) · [Up: contents](index.md) · [help(bs.findall) →](09-help-bs-findall.md)
