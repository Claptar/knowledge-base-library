---
title: ssh -Y @gandalf.berkeley.edu
...
[← Command(s) to run](13-command-s-to-run.md) · [Up: contents](index.md) · [10 minute time limit →](15-10-minute-time-limit.md)
