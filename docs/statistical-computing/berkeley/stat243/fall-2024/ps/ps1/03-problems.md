---
title: Problems
source: https://github.com/berkeley-stat243/fall-2024/blob/9c62305d05fca31df0d9c6a3b68b350ad8722fee/ps/ps1.qmd
source_file: sources/berkeley-stat243/fall-2024/ps/ps1.qmd
licence: CC BY 4.0
route: markdown
fidelity: lossless
...
**Source:** [`ps/ps1.qmd`](https://github.com/berkeley-stat243/fall-2024/blob/9c62305d05fca31df0d9c6a3b68b350ad8722fee/ps/ps1.qmd) · **Licence:** CC BY 4.0 · Converted 2026-09-14 from `.qmd` (lossless)
...
4. We'll experiment with webscraping and manipulating HTML by getting publication information off of Google Scholar. Note that Google Scholar does not have an API, so we are forced to deconstruct the queries that are produced when we point and click on the website.
   ...
   d. Create a [requirements file (based on either pip or Conda)](../../units/unit4-goodPractices/index.md) that has the necessary information (in particular Python package versions) to reproduce the environment in which you ran your code. Include this file in your GitHub repository directory for this problem set.
