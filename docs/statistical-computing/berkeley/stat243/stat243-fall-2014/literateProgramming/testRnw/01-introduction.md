...
<span style="color: 0.501960784313725,0,0.329411764705882">**`library`**</span>`(knitr)`
<span style="color: 0.501960784313725,0,0.329411764705882">**`knit`**</span>`(`<span style="color: 0.6,0.6,1">`"testRnw.Rnw"`</span>`)`
<span style="color: 0.501960784313725,0,0.329411764705882">**`system`**</span>`(`<span style="color: 0.6,0.6,1">`"pdflatex`\ `testRnw"`</span>`)`
