---
title: Using apply, sapply, and lapply {#using-apply-sapply-and-lapply .unnumbered}
...
# Using apply, sapply, and lapply {#using-apply-sapply-and-lapply .unnumbered}
...
[← Vectorized calculations {#vectorized-calculations .unnumbered}](04-vectorized-calculations-vectorized-calculations-unnumbered.md) · [Up: contents](index.md) · [Functions {#functions .unnumbered} →](06-functions-functions-unnumbered.md)
