---
title: Topics (in order with rough timing)
...
2. Using R: functions and variable scope, data and text manipulation, strings and regular expressions, data input/output (6 days)

3. Debugging, good programming practices, reproducible research (2 days)

4. Advanced R programming: environments, object oriented programming, efficient programming, computing on the language (6 days)
...
9. Numerical linear algebra (6 days)
...
If you want to get a sense of what material we will cover in more detail, in advance, you can take a look at the materials in the lectures directory of Github repository from last year. Material will be quite similar though I’ll be making modifications along the way and it’s possible unit numbers will have changed.
...
[← Feedback](10-feedback.md) · [Up: contents](index.md)
