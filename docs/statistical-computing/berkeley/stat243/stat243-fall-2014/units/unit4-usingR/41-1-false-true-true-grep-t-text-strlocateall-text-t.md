---
title: '[1] FALSE TRUE TRUE ## grep(''[ \t]'', text) strlocateall (text, "[ \t]")'
...
# [1] FALSE TRUE TRUE ## grep('[ \t]', text) strlocateall (text, "[ \t]")
...
## [1] FALSE TRUE TRUE _## grep('[ \t]', text)_ **str_locate_all** (text, "[ \t]")

---

[← Unit 04 — usingR Part 40 —](40-unit-04-usingr-part-40.md) · [Up: contents](index.md) · [[[1]] ## start end ## ## [[2]] ## start end →](42-1-start-end-2-start-end.md)
