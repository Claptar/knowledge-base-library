...
myFun2 <- **with** ( **list** (data = x), **function** (param) **return** (param * data)) **rm** (x) **myFun2** (3)

---

[← 2 Advanced topics in working with functions](05-2-advanced-topics-in-working-with-functions.md) · [Up: contents](index.md) · [Unit 06 — Rprog Part 07 — →](07-unit-06-rprog-part-07.md)
