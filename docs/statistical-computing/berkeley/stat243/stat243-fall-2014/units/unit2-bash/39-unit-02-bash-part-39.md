...
cd /tmp/git-demo git checkout master echo "More work on the master branch..." >> experiment.txt git commit -am"Mainline work"

---

[← Unit 02 — bash Part 38 —](38-unit-02-bash-part-38.md) · [Up: contents](index.md) · [Unit 02 — bash Part 40 — →](40-unit-02-bash-part-40.md)
