...
cd /tmp/git-demo git merge trouble ## Auto-merging experiment.txt

---

[← Unit 02 — bash Part 39 —](39-unit-02-bash-part-39.md) · [Up: contents](index.md) · [CONFLICT (content): Merge conflict in experiment.txt →](41-conflict-content-merge-conflict-in-experiment-txt.md)
