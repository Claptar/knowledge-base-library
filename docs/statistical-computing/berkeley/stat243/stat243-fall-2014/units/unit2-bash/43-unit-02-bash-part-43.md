...
[← Automatic merge failed; fix conflicts and then commit the result.](42-automatic-merge-failed-fix-conflicts-and-then-commit-the-res.md) · [Up: contents](index.md) · [Unit 02 — bash Part 44 — →](44-unit-02-bash-part-44.md)
