...
0.3 - 0.2 == 0.1 ## [1] FALSE 0.3 ## [1] 0.3 0.2 ## [1] 0.2 0.1 _# Hmmm..._ ## [1] 0.1 **options** (digits = 22) a <- 0.3 b <- 0.2 a

3

---

[← 1 Basic representations](02-1-basic-representations.md) · [Up: contents](index.md) · [Unit 07 — numbers Part 04 — →](04-unit-07-numbers-part-04.md)
