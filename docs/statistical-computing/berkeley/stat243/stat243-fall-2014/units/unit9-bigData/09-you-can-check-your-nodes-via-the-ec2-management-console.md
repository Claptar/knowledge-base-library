---
title: you can check your nodes via the EC2 management console
...
[← ssh -i ~/.ssh/ec2star.rsa root@ec2-54-71-204-234.us-west-2.compute.amazonaws.com](08-ssh--i-ssh-ec2star-rsa-root-ec2-54-71-204-234-us-west-2-comp.md) · [Up: contents](index.md) · [Unit 09 — bigData Part 10 — →](10-unit-09-bigdata-part-10.md)
