...
AWS_ACCESS_KEY_ID=$(grep "^AWS_ACCESS_KEY_ID" ~/.starcluster/config | cut -d' #AWS_SECRET_ACCESS_KEY=blahhhh

AWS_SECRET_ACCESS_KEY=$(grep "^AWS_SECRET_ACCESS_KEY" ~/.starcluster/config

---

[← Unit 09 — bigData Part 02 —](02-unit-09-bigdata-part-02.md) · [Up: contents](index.md) · [start cluster →](04-start-cluster.md)
