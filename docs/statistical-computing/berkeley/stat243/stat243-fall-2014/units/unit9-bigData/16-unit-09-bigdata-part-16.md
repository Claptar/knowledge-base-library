...
# particularly for in-class demo - good to repartition the 3 files to more # lines = lines.repartition(96).cache()

---

[← Unit 09 — bigData Part 15 —](15-unit-09-bigdata-part-15.md) · [Up: contents](index.md) · [mapper def stratify(line): vals = line.split(',') return(vals[16], 1) →](17-mapper-def-stratify-line-vals-line-split-return-vals-16-1.md)
