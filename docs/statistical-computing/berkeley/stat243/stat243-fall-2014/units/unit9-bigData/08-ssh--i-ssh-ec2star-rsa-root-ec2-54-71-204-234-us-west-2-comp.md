---
title: ssh -i ~/.ssh/ec2star.rsa root@ec2-54-71-204-234.us-west-2.compute.amazonaws.com
...
[← or you can ssh in directly if you know the URL](07-or-you-can-ssh-in-directly-if-you-know-the-url.md) · [Up: contents](index.md) · [you can check your nodes via the EC2 management console →](09-you-can-check-your-nodes-via-the-ec2-management-console.md)
