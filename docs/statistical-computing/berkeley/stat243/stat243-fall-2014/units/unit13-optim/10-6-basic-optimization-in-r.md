...
- The _optimx_ package provides _optimx()_ , which is a wrapper for a variety of optimization methods (including many of those in _optim()_ , as well as _nlm()_ . One nice feature is that it

26

allow you to use multiple methods in the same function call.
...
[← 5 Multivariate optimization](09-5-multivariate-optimization.md) · [Up: contents](index.md) · [7 Combinatorial optimization over discrete spaces →](11-7-combinatorial-optimization-over-discrete-spaces.md)
