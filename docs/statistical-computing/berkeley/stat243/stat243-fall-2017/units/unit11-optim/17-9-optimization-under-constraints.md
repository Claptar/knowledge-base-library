...
out <- **constrOptim** ( **c** (.5,0), fr, grr, ui = ui, ci = ci) out$par

---

[← 8 Convexity](16-8-convexity.md) · [Up: contents](index.md) · [[1] 0.8999999996 0.8100006078 points (out$par[1], out$par[2]) text (-1,-2, "I", cex = 2) →](18-1-0-8999999996-0-8100006078-points-outpar-2-text--1--2-i-cex.md)
