...
uphill to local maximum<br>45678913<br>f(x)<br>f'(x)<br>1 f"(x)<br>0 1 2 3 4 5 6<br>x<br>converges to minimum<br>2<br>4<br>567891<br>f(x)<br>3 f'(x)<br>1 f"(x)<br>0 1 2 3 4 5 6<br>x<br>converges to minimum, better starting point<br>2<br>34567891<br>f(x)<br>1 f'(x)<br>f"(x)<br>0 1 2 3 4 5 6<br>x<br>1.0<br>0.5<br>f'(x) 0.0<br>−1.0<br>1.0<br>0.5<br>f'(x) 0.0<br>−1.0<br>1.0<br>0.5<br>f'(x) 0.0<br>−1.0<br><!-- End of picture text -->
