...
x <- 3 **x** (2) **## Error in x(2): could not find function "x"**

36

x <- **function** (z) z^2 **x** (2) ## [1] 4 **class** (x); **typeof** (x) ## [1] "function" ## [1] "closure"

We can call a function based on the text name of the function.

myFun <- 'mean'; x <- **rnorm** (10) **eval** ( **as.name** (myFun))(x) ## [1] -0.159
...
x <- **rnorm** (10) f <- **function** (fxn, x) { **fxn** (x) } **f** (mean, x) ## [1] -0.163
...
[← 5 Standard dataset manipulations](28-5-standard-dataset-manipulations.md) · [Up: contents](index.md) · [[1] -0.163 f (mean, x) ## [1] -0.163 →](30-1--0-163-f-mean-x-1--0-163.md)
