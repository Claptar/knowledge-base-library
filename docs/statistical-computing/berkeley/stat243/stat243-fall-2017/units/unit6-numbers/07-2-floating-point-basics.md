...
0.3 - 0.2 == 0.1 ## [1] FALSE 0.3 ## [1] 0.3 0.2 ## [1] 0.2 0.1 _# Hmmm..._ ## [1] 0.1 **options** (digits=22) _## on some machines this may not have ## have any effect in showing more digits..._ a <- 0.3 b <- 0.2 a ## [1] 0.2999999999999999888978

5

b ## [1] 0.2000000000000000111022 a - b ## [1] 0.09999999999999997779554 0.1 ## [1] 0.1000000000000000055511 1/3 ## [1] 0.3333333333333333148296 _# so empirically, it looks like we're accurate up to the # 16th decimal place_
...
1e-16 + 1 ## [1] 1 1e-15 + 1 ## [1] 1.000000000000001110223 2e-16 + 1 ## [1] 1.000000000000000222045 .Machine$double.eps ## [1] 2.220446049250313080847e-16 .Machine$double.eps + 1 ## [1] 1.000000000000000222045

6

_Floating point_ refers to the decimal point (or radix point since we’ll be working with base 2 and _decimal_ relates to 10). Consider Avogadro’s number in terms of scientific notation: +6 _._ 023 _×_ 10<sup>23</sup> . A real number on a computer is stored in what is basically scientific notation:
