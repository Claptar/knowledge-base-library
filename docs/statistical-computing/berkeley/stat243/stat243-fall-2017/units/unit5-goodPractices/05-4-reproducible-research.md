...
1. In some cases you may be able to carry out your complete workflow in a knitr/Sweave/R Markdown document or in a Jupyter notebook (e.g., IPython notebook, Jupyter-based R notebook).

2. You might consider using the UNIX utility _make_ , which is generally used for compiling code, as a tool for reproducible research: see the tutorial on _Using make for workflows_ for more details.
