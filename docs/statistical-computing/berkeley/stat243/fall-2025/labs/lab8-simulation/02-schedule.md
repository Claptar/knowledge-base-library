---
title: Schedule
source: https://github.com/berkeley-stat243/fall-2025/blob/035a19ebd7ab88cffca907cade6d40212d575a1f/labs/lab8-simulation.qmd
source_file: sources/berkeley-stat243/fall-2025/labs/lab8-simulation.qmd
licence: CC BY 4.0
route: markdown
fidelity: lossless
...
**Source:** [`labs/lab8-simulation.qmd`](https://github.com/berkeley-stat243/fall-2025/blob/035a19ebd7ab88cffca907cade6d40212d575a1f/labs/lab8-simulation.qmd) · **Licence:** CC BY 4.0 · Converted 2026-09-14 from `.qmd` (lossless)
...
4. Discuss how the authors generate their **simulated datasets**, as described
   ...
   - They use the multivariate normal (MVN) distribution for part of their
     ...
     Cholesky decomposition (described in [Unit 9](https://github.com/berkeley-stat243/fall-2025/blob/035a19ebd7ab88cffca907cade6d40212d575a1f/labs/units/unit9-sim.html))?
...
[← Overview](01-overview.md) · [Up: contents](index.md)
