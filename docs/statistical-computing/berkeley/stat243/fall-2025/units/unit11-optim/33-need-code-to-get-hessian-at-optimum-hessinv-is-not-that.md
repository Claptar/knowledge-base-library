---
title: Need code to get Hessian at optimum; hessinv is NOT that.
...
# Need code to get Hessian at optimum; hessinv is NOT that.
...
[← Optimization using BFGS](32-optimization-using-bfgs.md) · [Up: contents](index.md) · [Different starting values →](34-different-starting-values.md)
