...
[← Data on a different scale](36-data-on-a-different-scale.md) · [Up: contents](index.md) · [7. Combinatorial optimization over discrete spaces →](38-7-combinatorial-optimization-over-discrete-spaces.md)
