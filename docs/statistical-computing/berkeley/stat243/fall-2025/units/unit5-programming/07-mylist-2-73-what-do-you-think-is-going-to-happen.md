...
Object protocols are implemented based on the [Python object model](12-6-object-oriented-programming-oop.md#the-python-object-model-and-dunder-methods) using **dunder** methods.
...
[← myList[2.0] # What do you think is going to happen?](06-mylist-2-0-what-do-you-think-is-going-to-happen.md) · [Up: contents](index.md) · [5. Programming paradigms: object-oriented and functional programming →](08-5-programming-paradigms-object-oriented-and-functional-progr.md)
