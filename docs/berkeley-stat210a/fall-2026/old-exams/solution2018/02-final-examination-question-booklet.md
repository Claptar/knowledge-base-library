...
- (c) Consider the score test of _H_ 0 : _θ_ = _θ_ 0 vs. _H_ 1 : _θ > θ_ 0. Give an explicit expression for both the test statistic and its rejection threshold, and show that the test achieves finite-sample control of the Type I error rate.
...
[← Solution2018 Part 01 —](01-solution2018-part-01.md) · [Up: contents](index.md) · [Problem 1 Solutions →](03-problem-1-solutions.md)
