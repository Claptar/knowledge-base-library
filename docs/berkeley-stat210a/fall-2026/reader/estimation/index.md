...
1. [Statistical models](01-statistical-models.md)
2. [Estimation in statistical models](02-estimation-in-statistical-models.md)
3. [risk function of estimator (X + synth.heads) / (n + synth.flips)](03-risk-function-of-estimator-x-synth-heads-n-synth-flips.md)
