---
title: We'll compute power curves for a grid of d and k values
...
[← p-Values](02-p-values.md) · [Up: contents](index.md) · [and pass them to OJS as data →](04-and-pass-them-to-ojs-as-data.md)
