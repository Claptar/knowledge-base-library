---
title: mesh on the 3 axes; 'ij' preserves axis ordering
...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [keep only nondecreasing triples to kill permutations →](03-keep-only-nondecreasing-triples-to-kill-permutations.md)
