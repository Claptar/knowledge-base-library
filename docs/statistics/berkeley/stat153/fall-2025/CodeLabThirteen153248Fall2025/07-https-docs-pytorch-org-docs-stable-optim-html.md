---
title: https://docs.pytorch.org/docs/stable/optim.html
...
[← Define an optimizer](06-define-an-optimizer.md) · [Up: contents](index.md) · [try lr = 0.01, 0.1 and 1 →](08-try-lr-0-01-0-1-and-1.md)
