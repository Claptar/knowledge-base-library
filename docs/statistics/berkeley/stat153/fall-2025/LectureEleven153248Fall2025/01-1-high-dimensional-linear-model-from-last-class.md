---
title: 1 High-dimensional Linear Model from last class
...
In the last lecture, we introduced the following model for a given time series _y_ 1 _, . . . , yn_ :
...
The unknown parameters in this model are _β_ 0 _, β_ 1 _, . . . , βn−_ 1 as well as _σ_ . This is a highdimensional model because the number of parameters (which is _n_ + 1) is larger than the sample size _n_ .
