---
title: 'Initial guess: [muinit, thetainit]'
...
# Initial guess: [muinit, thetainit]
...
[← Plot sample ACF/PACF](08-plot-sample-acf-pacf.md) · [Up: contents](index.md) · [Perform the optimization →](10-perform-the-optimization.md)
