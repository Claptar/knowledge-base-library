...
1. [1 Recap: Ridge Regression](01-1-recap-ridge-regression.md)
2. [2 Bayesian Regularization](02-2-bayesian-regularization.md)
3. [3 Bayesian approach for dealing with unknown τ and σ](03-3-bayesian-approach-for-dealing-with-unknown-τ-and-σ.md)
4. [4 Comments on Bayesian Regularization](04-4-comments-on-bayesian-regularization.md)
