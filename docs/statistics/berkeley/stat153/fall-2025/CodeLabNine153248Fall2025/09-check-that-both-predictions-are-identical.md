...
while p <= max_p:
    ...
    # sometimes this is throwing an error saying that conf_ints is not a pandas array (in such cases, use conf_ints[-1,:])
    if (lower < 0 < upper):
...
Date:                Fri, 31 Oct 2025   AIC                          -1730.451
Time:                        19:31:09   BIC                          -1712.050
...
[← extend data by k placeholder values](08-extend-data-by-k-placeholder-values.md) · [Up: contents](index.md) · [extend data by k placeholder values →](10-extend-data-by-k-placeholder-values.md)
