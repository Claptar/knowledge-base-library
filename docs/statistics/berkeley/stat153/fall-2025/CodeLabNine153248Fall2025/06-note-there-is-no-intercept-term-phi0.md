...
[← yt = \phi1 y{t-1} + \dots + \phip y{t-p} + \epsilont](05-yt-phi1-y-t-1-dots-phip-y-t-p-epsilont.md) · [Up: contents](index.md) · [the default choice is trend = 'c' so we can just drop it if we want →](07-the-default-choice-is-trend-c-so-we-can-just-drop-it-if-we-w.md)
