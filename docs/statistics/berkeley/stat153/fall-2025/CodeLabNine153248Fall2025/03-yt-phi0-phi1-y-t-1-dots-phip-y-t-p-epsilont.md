---
title: yt = phi0 + \phi1 y{t-1} + \dots + \phip y{t-p} + \epsilont
...
# yt = phi0 + \phi1 y{t-1} + \dots + \phip y{t-p} + \epsilont
...
[← trend = 'c' will fit the model](02-trend-c-will-fit-the-model.md) · [Up: contents](index.md) · [trend = 'n' will fit the model →](04-trend-n-will-fit-the-model.md)
