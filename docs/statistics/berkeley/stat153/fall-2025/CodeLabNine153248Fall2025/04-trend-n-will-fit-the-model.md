---
title: trend = 'n' will fit the model
...
[← yt = phi0 + \phi1 y{t-1} + \dots + \phip y{t-p} + \epsilont](03-yt-phi0-phi1-y-t-1-dots-phip-y-t-p-epsilont.md) · [Up: contents](index.md) · [yt = \phi1 y{t-1} + \dots + \phip y{t-p} + \epsilont →](05-yt-phi1-y-t-1-dots-phip-y-t-p-epsilont.md)
