---
title: yt = \phi1 y{t-1} + \dots + \phip y{t-p} + \epsilont
...
# yt = \phi1 y{t-1} + \dots + \phip y{t-p} + \epsilont
...
[← trend = 'n' will fit the model](04-trend-n-will-fit-the-model.md) · [Up: contents](index.md) · [(note there is no intercept term phi0) →](06-note-there-is-no-intercept-term-phi0.md)
