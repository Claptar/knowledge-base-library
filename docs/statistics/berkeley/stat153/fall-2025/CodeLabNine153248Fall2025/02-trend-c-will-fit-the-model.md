---
title: trend = 'c' will fit the model
...
[← AR models (estimation, inference and prediction)](01-ar-models-estimation-inference-and-prediction.md) · [Up: contents](index.md) · [yt = phi0 + \phi1 y{t-1} + \dots + \phip y{t-p} + \epsilont →](03-yt-phi0-phi1-y-t-1-dots-phip-y-t-p-epsilont.md)
