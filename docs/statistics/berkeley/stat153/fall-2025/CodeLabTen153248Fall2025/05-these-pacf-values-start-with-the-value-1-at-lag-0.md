---
title: these pacf values start with the value 1 at lag 0.
...
[← this gives \psij, j = 0, \dots, lags-1](04-this-gives-psij-j-0-dots-lags-1.md) · [Up: contents](index.md) · [these are the coefficients of the characteristic polynomial →](06-these-are-the-coefficients-of-the-characteristic-polynomial.md)
