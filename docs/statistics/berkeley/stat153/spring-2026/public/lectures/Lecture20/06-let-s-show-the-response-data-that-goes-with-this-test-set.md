...
[← Let's look at what we're using for our xtrain matrices](05-let-s-look-at-what-we-re-using-for-our-xtrain-matrices.md) · [Up: contents](index.md) · [How do we choose the lags? →](07-how-do-we-choose-the-lags.md)
