...
[← How do we choose the lags?](07-how-do-we-choose-the-lags.md) · [Up: contents](index.md) · [Average |CCF| across features, then show per-electrode traces + mean →](09-average-ccf-across-features-then-show-per-electrode-traces-m.md)
