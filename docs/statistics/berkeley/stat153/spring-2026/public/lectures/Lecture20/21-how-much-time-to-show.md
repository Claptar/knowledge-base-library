...
[← Plot a line at the maximum alpha. This should be in the middle](20-plot-a-line-at-the-maximum-alpha-this-should-be-in-the-middl.md) · [Up: contents](index.md) · [Plot predictions vs. actual response →](22-plot-predictions-vs-actual-response.md)
