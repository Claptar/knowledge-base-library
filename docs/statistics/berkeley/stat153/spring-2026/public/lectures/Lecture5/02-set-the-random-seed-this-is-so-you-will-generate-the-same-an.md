---
title: Set the random seed, this is so you will generate the same answers
...
[← Lecture 5 - Simple linear regression](01-lecture-5---simple-linear-regression.md) · [Up: contents](index.md) · [each time (for example, when generating white noise) →](03-each-time-for-example-when-generating-white-noise.md)
