---
title: y = 2 np.sin(1.3 np.pi s) - 1 s
...
[← x = 2 np.cos(2.3 np.pi s) + 1 s](07-x-2-np-cos-2-3-np-pi-s-1-s.md) · [Up: contents](index.md) · [return np.stack([x, y], axis=1) →](09-return-np-stack-x-y-axis-1.md)
