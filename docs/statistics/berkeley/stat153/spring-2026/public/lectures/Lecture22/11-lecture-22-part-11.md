...
[← def gentruth(N=60)](10-def-gentruth-n-60.md) · [Up: contents](index.md) · [Linear trajectory (constant velocity) →](12-linear-trajectory-constant-velocity.md)
