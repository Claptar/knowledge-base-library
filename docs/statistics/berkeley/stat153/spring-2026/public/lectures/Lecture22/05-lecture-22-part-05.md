...
[← Generate a more complex trajectory](04-generate-a-more-complex-trajectory.md) · [Up: contents](index.md) · [s = np.linspace(0, 1, N) →](06-s-np-linspace-0-1-n.md)
