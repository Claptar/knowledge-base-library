...
[← def gentruth(N=60)](02-def-gentruth-n-60.md) · [Up: contents](index.md) · [Generate a more complex trajectory →](04-generate-a-more-complex-trajectory.md)
