---
title: x = 2 np.cos(2.3 np.pi s) + 1 s
...
[← s = np.linspace(0, 1, N)](06-s-np-linspace-0-1-n.md) · [Up: contents](index.md) · [y = 2 np.sin(1.3 np.pi s) - 1 s →](08-y-2-np-sin-1-3-np-pi-s---1-s.md)
