...
[← return np.stack([x,y], axis=1)](17-return-np-stack-x-y-axis-1.md) · [Up: contents](index.md) · [This seems to help make the figure not jump around →](19-this-seems-to-help-make-the-figure-not-jump-around.md)
