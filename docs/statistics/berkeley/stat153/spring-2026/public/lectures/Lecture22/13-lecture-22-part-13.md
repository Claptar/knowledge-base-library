...
[← Linear trajectory (constant velocity)](12-linear-trajectory-constant-velocity.md) · [Up: contents](index.md) · [s = np.linspace(0, 1, N) →](14-s-np-linspace-0-1-n.md)
