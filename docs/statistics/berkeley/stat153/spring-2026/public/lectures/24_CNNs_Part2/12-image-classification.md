...
- We know from neuroscience that visual neurons have limited **_receptive fields_**

---

[← Image classification](11-image-classification.md) · [Up: contents](index.md) · [Image Classification →](13-image-classification.md)
