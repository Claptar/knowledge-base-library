...
- <sup>You work at an investment bank, and you want to predict what the price  of a</sup> _y_ particular stock will be tomorrow, _yt_ +1
...
[← Today](02-today.md) · [Up: contents](index.md) · [Time Series Prediction →](04-time-series-prediction.md)
