...
- The **standard RNN** , **vanilla RNN** , or **Elman network** is given by the following equations: _ht_ = tanh( _Whht_ −1 + _Wxxt_ + _bh_ )̂ _yt_ = _Wyht_ + _by_

- This example uses a **tanh** nonlinearity. It could also use a **sigmoid** , but it’s rare to use a **ReLU** (like we do with CNNs).

---

[← Recurrent neural networks (RNNs)](15-recurrent-neural-networks-rnns.md) · [Up: contents](index.md) · [How do we train an RNN? →](17-how-do-we-train-an-rnn.md)
