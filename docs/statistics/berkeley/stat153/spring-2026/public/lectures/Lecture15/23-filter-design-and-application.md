---
title: Filter design and application
...
[← Welch does this averaging for us](22-welch-does-this-averaging-for-us.md) · [Up: contents](index.md) · [First run this cell to get the functions we need to create and apply filters to the data →](24-first-run-this-cell-to-get-the-functions-we-need-to-create-a.md)
