---
title: 'This is the key visualization: each chunk gives a DIFFERENT periodogram,'
...
[← --- Overlay raw periodograms from different chunks ---](18-----overlay-raw-periodograms-from-different-chunks.md) · [Up: contents](index.md) · [even though the signal is approximately stationary. →](20-even-though-the-signal-is-approximately-stationary.md)
