---
title: even though the signal is approximately stationary.
...
[← This is the key visualization: each chunk gives a DIFFERENT periodogram,](19-this-is-the-key-visualization-each-chunk-gives-a-different-p.md) · [Up: contents](index.md) · [Welch averages over these to reduce variance. →](21-welch-averages-over-these-to-reduce-variance.md)
