---
title: scipy.signal.sosfiltfilt — apply it (zero-phase, so no time shift)
...
[← scipy.signal.butter — design a Butterworth filter](25-scipy-signal-butter-design-a-butterworth-filter.md) · [Up: contents](index.md) · [scipy.signal.sosfreqz — compute the filter's frequency response →](27-scipy-signal-sosfreqz-compute-the-filter-s-frequency-respons.md)
