---
title: This is the same Δf = fs/N relationship from when we discussed
...
[← Let's look at how nperseg affects both ∆t and ∆f](10-let-s-look-at-how-nperseg-affects-both-t-and-f.md) · [Up: contents](index.md) · [periodogram frequency resolution. →](12-periodogram-frequency-resolution.md)
