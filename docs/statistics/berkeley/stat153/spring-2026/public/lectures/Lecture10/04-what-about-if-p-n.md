...
[← Let's plot it and our x and y origin lines](03-let-s-plot-it-and-our-x-and-y-origin-lines.md) · [Up: contents](index.md) · [Make a new grid of frequencies from 1 to the Nyquist limit →](05-make-a-new-grid-of-frequencies-from-1-to-the-nyquist-limit.md)
