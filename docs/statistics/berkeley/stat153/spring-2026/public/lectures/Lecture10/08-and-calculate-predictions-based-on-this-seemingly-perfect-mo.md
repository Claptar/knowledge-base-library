---
title: and calculate predictions based on this seemingly "perfect" model.
...
[← Now let's make a new X matrix for our test data of the correct dimensions](07-now-let-s-make-a-new-x-matrix-for-our-test-data-of-the-corre.md) · [Up: contents](index.md) · [Loop through all the same frequencies we tried before and add them to our model →](09-loop-through-all-the-same-frequencies-we-tried-before-and-ad.md)
