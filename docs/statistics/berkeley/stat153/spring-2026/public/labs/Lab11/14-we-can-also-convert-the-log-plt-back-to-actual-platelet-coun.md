---
title: We can also convert the log(PLT) back to actual platelet count,
...
[← Platelet forecast at day 100](13-platelet-forecast-at-day-100.md) · [Up: contents](index.md) · [which we reference from the paper (Bolwell et al) →](15-which-we-reference-from-the-paper-bolwell-et-al.md)
