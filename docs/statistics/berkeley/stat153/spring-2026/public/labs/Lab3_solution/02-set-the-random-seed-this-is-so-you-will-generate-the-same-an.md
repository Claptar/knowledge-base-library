...
[← Lab 3 Solutions - Stat 153/248](01-lab-3-solutions---stat-153-248.md) · [Up: contents](index.md) · [each time (for example, when generating white noise) →](03-each-time-for-example-when-generating-white-noise.md)
