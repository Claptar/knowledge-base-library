---
title: Now plot the predictions - we can do this a few ways, either using
...
[← each time (for example, when generating white noise)](03-each-time-for-example-when-generating-white-noise.md) · [Up: contents](index.md) · [fitted values or using the parameters directly →](05-fitted-values-or-using-the-parameters-directly.md)
