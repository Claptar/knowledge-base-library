...
[← To show the confidence intervals on the data, we can use the getprediction method](09-to-show-the-confidence-intervals-on-the-data-we-can-use-the.md) · [Up: contents](index.md) · [Now let's fit a regression to this →](11-now-let-s-fit-a-regression-to-this.md)
