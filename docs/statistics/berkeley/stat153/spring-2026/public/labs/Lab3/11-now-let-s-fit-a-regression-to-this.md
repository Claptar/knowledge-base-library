...
[← Fix the time index](10-fix-the-time-index.md) · [Up: contents](index.md) · [Make sure we get the new time index as well →](12-make-sure-we-get-the-new-time-index-as-well.md)
