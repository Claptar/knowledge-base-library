---
title: Let's print all the possible datasets we could load from the book
...
[← Data from Time Series Analysis and Its Applications](04-data-from-time-series-analysis-and-its-applications.md) · [Up: contents](index.md) · [These are functions named loadX →](06-these-are-functions-named-loadx.md)
