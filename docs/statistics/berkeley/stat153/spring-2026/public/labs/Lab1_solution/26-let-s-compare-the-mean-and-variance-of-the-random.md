---
title: Let's compare the mean and variance of the random
...
[← back...?)](25-back.md) · [Up: contents](index.md) · [walk with drift to our example above. Let's create →](27-walk-with-drift-to-our-example-above-let-s-create.md)
