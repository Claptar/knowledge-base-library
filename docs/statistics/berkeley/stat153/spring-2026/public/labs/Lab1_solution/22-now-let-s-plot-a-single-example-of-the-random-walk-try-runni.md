---
title: Now let's plot a single example of the random walk. Try running a few times
...
[← Random Walk with Drift](21-random-walk-with-drift.md) · [Up: contents](index.md) · [with different parameters. How does the drift parameter influence what →](23-with-different-parameters-how-does-the-drift-parameter-influ.md)
