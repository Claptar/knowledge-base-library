---
title: a matrix of random walks with drift - nwalks samples
...
[← walk with drift to our example above. Let's create](27-walk-with-drift-to-our-example-above-let-s-create.md) · [Up: contents](index.md) · [and nt time points for drift drift. →](29-and-nt-time-points-for-drift-drift.md)
