...
[← Lab 1 - Stat 153/248 - Solutions](01-lab-1---stat-153-248---solutions.md) · [Up: contents](index.md) · [each time (for example, when generating white noise) →](03-each-time-for-example-when-generating-white-noise.md)
