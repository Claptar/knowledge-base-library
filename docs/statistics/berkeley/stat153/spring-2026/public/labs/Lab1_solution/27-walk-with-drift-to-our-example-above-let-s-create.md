---
title: walk with drift to our example above. Let's create
...
[← Let's compare the mean and variance of the random](26-let-s-compare-the-mean-and-variance-of-the-random.md) · [Up: contents](index.md) · [a matrix of random walks with drift - nwalks samples →](28-a-matrix-of-random-walks-with-drift---nwalks-samples.md)
