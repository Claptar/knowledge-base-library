---
title: (where each sample is from one day). What happens
...
[← Try applying the moving average to the DJIA data](33-try-applying-the-moving-average-to-the-djia-data.md) · [Up: contents](index.md) · [when you apply the average over a month, a year, etc? →](35-when-you-apply-the-average-over-a-month-a-year-etc.md)
