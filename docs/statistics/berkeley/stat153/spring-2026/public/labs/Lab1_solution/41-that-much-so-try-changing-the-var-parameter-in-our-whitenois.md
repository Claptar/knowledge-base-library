---
title: that much, so try changing the var parameter in our whitenoise
...
# that much, so try changing the var parameter in our whitenoise
...
[← add the white noise with the default variance, it may not affect our signal](40-add-the-white-noise-with-the-default-variance-it-may-not-aff.md) · [Up: contents](index.md) · [function →](42-function.md)
