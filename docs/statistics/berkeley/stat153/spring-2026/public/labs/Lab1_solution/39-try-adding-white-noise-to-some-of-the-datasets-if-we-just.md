---
title: Try adding white noise to some of the datasets. If we just
...
[← Plot the smoothed speech data](38-plot-the-smoothed-speech-data.md) · [Up: contents](index.md) · [add the white noise with the default variance, it may not affect our signal →](40-add-the-white-noise-with-the-default-variance-it-may-not-aff.md)
