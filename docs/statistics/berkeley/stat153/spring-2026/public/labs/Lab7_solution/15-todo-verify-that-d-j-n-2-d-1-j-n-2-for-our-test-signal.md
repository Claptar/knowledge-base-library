---
title: 'TODO: Verify that |d(j/n)|^2 = |d(1-j/n)|^2 for our test signal'
...
[← even if the scale differs. What normalization does scipy use?](14-even-if-the-scale-differs-what-normalization-does-scipy-use.md) · [Up: contents](index.md) · [Hint: d(1 - j/n) corresponds to index (n - j) in the array →](16-hint-d-1---j-n-corresponds-to-index-n---j-in-the-array.md)
