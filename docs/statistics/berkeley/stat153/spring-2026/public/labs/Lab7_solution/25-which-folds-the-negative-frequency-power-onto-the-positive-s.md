---
title: which folds the negative-frequency power onto the positive side,
...
[← Note that scipy.signal.periodogram returns a one-sided spectrum by default (only [0,1/2]),](24-note-that-scipy-signal-periodogram-returns-a-one-sided-spect.md) · [Up: contents](index.md) · [effectively doubling the values. →](26-effectively-doubling-the-values.md)
