---
title: Compute using numpy (adjust for our convention)
...
[← Compute using your function](03-compute-using-your-function.md) · [Up: contents](index.md) · [numpy uses t=0,...,n-1 and no 1/sqrt(n) normalization →](05-numpy-uses-t-0-n-1-and-no-1-sqrt-n-normalization.md)
