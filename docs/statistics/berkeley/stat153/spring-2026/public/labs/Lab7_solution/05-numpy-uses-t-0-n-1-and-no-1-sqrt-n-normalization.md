---
title: numpy uses t=0,...,n-1 and no 1/sqrt(n) normalization
...
[← Compute using numpy (adjust for our convention)](04-compute-using-numpy-adjust-for-our-convention.md) · [Up: contents](index.md) · [Our convention uses t=1,...,n and 1/sqrt(n) →](06-our-convention-uses-t-1-n-and-1-sqrt-n.md)
