---
title: Our convention uses t=1,...,n and 1/sqrt(n)
...
[← numpy uses t=0,...,n-1 and no 1/sqrt(n) normalization](05-numpy-uses-t-0-n-1-and-no-1-sqrt-n-normalization.md) · [Up: contents](index.md) · [Lab7 solution Part 07 — →](07-lab7-solution-part-07.md)
