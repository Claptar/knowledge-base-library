...
[← Make a new X matrix with the original bestf we estimated from the training data, and](12-make-a-new-x-matrix-with-the-original-bestf-we-estimated-fro.md) · [Up: contents](index.md) · [More noise →](14-more-noise.md)
