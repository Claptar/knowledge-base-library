...
[← Creating a sinusoid](02-creating-a-sinusoid.md) · [Up: contents](index.md) · [Let's plot it and our x and y origin lines →](04-let-s-plot-it-and-our-x-and-y-origin-lines.md)
