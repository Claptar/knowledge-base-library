...
[← Finding the frequency, $f$](05-finding-the-frequency.md) · [Up: contents](index.md) · [That is - we are looking for the frequency at which RSS is minimized. →](07-that-is---we-are-looking-for-the-frequency-at-which-rss-is-m.md)
