...
[← What about new data?](11-what-about-new-data.md) · [Up: contents](index.md) · [Make a new X matrix with the original bestf we estimated from the training data, and →](13-make-a-new-x-matrix-with-the-original-bestf-we-estimated-fro.md)
