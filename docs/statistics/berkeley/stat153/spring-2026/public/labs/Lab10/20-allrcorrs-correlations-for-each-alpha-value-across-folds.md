---
title: 'allRcorrs: correlations for each alpha value across folds'
...
[← valphas: the best alphas for each electrode](19-valphas-the-best-alphas-for-each-electrode.md) · [Up: contents](index.md) · [valinds: indices for cross validation →](21-valinds-indices-for-cross-validation.md)
