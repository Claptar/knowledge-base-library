...
[← Regularization parameters (alphas - also sometimes called lambda)](15-regularization-parameters-alphas---also-sometimes-called-lam.md) · [Up: contents](index.md) · [beta: the beta values, →](17-beta-the-beta-values.md)
