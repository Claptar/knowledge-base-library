---
title: 'valinds: indices for cross validation'
...
[← allRcorrs: correlations for each alpha value across folds](20-allrcorrs-correlations-for-each-alpha-value-across-folds.md) · [Up: contents](index.md) · [pred: predictions →](22-pred-predictions.md)
