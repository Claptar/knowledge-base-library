---
title: 'corrs: correlations on held out data,'
...
[← beta: the beta values,](17-beta-the-beta-values.md) · [Up: contents](index.md) · [valphas: the best alphas for each electrode →](19-valphas-the-best-alphas-for-each-electrode.md)
