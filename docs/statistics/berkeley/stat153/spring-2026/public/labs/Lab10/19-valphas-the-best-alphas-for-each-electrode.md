---
title: 'valphas: the best alphas for each electrode'
...
[← corrs: correlations on held out data,](18-corrs-correlations-on-held-out-data.md) · [Up: contents](index.md) · [allRcorrs: correlations for each alpha value across folds →](20-allrcorrs-correlations-for-each-alpha-value-across-folds.md)
