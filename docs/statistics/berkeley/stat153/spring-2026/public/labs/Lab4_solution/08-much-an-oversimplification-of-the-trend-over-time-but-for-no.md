---
title: much an oversimplification of the trend over time, but for now
...
[← dfbins is the binned data when we use 10 second bins -- this is very](07-dfbins-is-the-binned-data-when-we-use-10-second-bins----this.md) · [Up: contents](index.md) · [is simple to look at →](09-is-simple-to-look-at.md)
