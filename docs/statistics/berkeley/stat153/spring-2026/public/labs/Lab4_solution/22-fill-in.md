...
[← the difference in Adj. R-squared compared to the last example.](21-the-difference-in-adj-r-squared-compared-to-the-last-example.md) · [Up: contents](index.md) · [Plots to look at balance within our data →](23-plots-to-look-at-balance-within-our-data.md)
