---
title: the difference in Adj. R-squared compared to the last example.
...
[← What if we just wanted to fit whether taps depend only on using dominant hand? Note](20-what-if-we-just-wanted-to-fit-whether-taps-depend-only-on-us.md) · [Up: contents](index.md) · [FILL IN →](22-fill-in.md)
