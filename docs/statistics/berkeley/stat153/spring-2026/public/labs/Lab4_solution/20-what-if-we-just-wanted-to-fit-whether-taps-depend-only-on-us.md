---
title: What if we just wanted to fit whether taps depend only on using dominant hand?
  Note
...
[← Fitting regression models](19-fitting-regression-models.md) · [Up: contents](index.md) · [the difference in Adj. R-squared compared to the last example. →](21-the-difference-in-adj-r-squared-compared-to-the-last-example.md)
