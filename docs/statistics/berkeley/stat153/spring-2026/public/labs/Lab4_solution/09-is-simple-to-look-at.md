...
[← much an oversimplification of the trend over time, but for now](08-much-an-oversimplification-of-the-trend-over-time-but-for-no.md) · [Up: contents](index.md) · [For example, the first row is for subj 0, timebin 0 corresponds to the →](10-for-example-the-first-row-is-for-subj-0-timebin-0-correspond.md)
