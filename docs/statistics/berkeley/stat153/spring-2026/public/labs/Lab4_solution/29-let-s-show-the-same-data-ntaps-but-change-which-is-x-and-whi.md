---
title: Let's show the same data (ntaps) but change which is x and which is hue.
...
[← by gamer vs. nongamer.](28-by-gamer-vs-nongamer.md) · [Up: contents](index.md) · [(Let's make the finger the color this time) →](30-let-s-make-the-finger-the-color-this-time.md)
