---
title: layer3 = nn.Conv1d(1, 4, kernelsize=5, padding=2)
...
# layer3 = nn.Conv1d(1, 4, kernelsize=5, padding=2)
...
[← print('\nkernelsize=5, padding=2, stride=1, length=10')](16-print-nkernelsize-5-padding-2-stride-1-length-10.md) · [Up: contents](index.md) · [print(layer3(torch.randn(2, 1, 10)).shape) →](18-print-layer3-torch-randn-2-1-10-shape.md)
