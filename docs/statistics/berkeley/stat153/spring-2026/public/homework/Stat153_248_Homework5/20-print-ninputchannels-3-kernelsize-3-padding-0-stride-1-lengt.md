---
title: print('\ninputchannels=3, kernelsize=3, padding=0, stride=1, length=10')
...
[← (3) inchannels=3](19-3-inchannels-3.md) · [Up: contents](index.md) · [layer4 = nn.Conv1d(3, 4, kernelsize=3) →](21-layer4-nn-conv1d-3-4-kernelsize-3.md)
