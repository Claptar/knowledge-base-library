---
title: 3. What if the input has 3 channels instead of 1 (so x.shape = (2, 3, 10)),
...
[← 2. What if you add padding=2 (with kernelsize=5)?](07-2-what-if-you-add-padding-2-with-kernelsize-5.md) · [Up: contents](index.md) · [with kernelsize=3 and outchannels=4? How many weights does the layer have now? →](09-with-kernelsize-3-and-outchannels-4-how-many-weights-does-th.md)
