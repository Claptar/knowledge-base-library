...
[← layer2 = nn.Conv1d(1, 4, kernelsize=5)](13-layer2-nn-conv1d-1-4-kernelsize-5.md) · [Up: contents](index.md) · [(2) kernelsize=5, padding=2 →](15-2-kernelsize-5-padding-2.md)
