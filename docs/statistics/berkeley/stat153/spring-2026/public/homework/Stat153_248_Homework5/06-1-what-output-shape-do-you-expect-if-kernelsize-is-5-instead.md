---
title: 1. What output shape do you expect if kernelsize is 5 instead of 3?
...
# 1. What output shape do you expect if kernelsize is 5 instead of 3?
...
[← Before running the lines below, predict](05-before-running-the-lines-below-predict.md) · [Up: contents](index.md) · [2. What if you add padding=2 (with kernelsize=5)? →](07-2-what-if-you-add-padding-2-with-kernelsize-5.md)
