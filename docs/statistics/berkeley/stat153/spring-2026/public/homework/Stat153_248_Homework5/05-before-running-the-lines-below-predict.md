...
[← ---- Predict-then-verify ----](04------predict-then-verify.md) · [Up: contents](index.md) · [1. What output shape do you expect if kernelsize is 5 instead of 3? →](06-1-what-output-shape-do-you-expect-if-kernelsize-is-5-instead.md)
