---
title: layer4 = nn.Conv1d(3, 4, kernelsize=3)
...
# layer4 = nn.Conv1d(3, 4, kernelsize=3)
...
[← print('\ninputchannels=3, kernelsize=3, padding=0, stride=1, length=10')](20-print-ninputchannels-3-kernelsize-3-padding-0-stride-1-lengt.md) · [Up: contents](index.md) · [print(layer4(torch.randn(2, 3, 10)).shape) →](22-print-layer4-torch-randn-2-3-10-shape.md)
