---
title: Uncomment one block at a time after making your prediction.
...
[← with kernelsize=3 and outchannels=4? How many weights does the layer have now?](09-with-kernelsize-3-and-outchannels-4-how-many-weights-does-th.md) · [Up: contents](index.md) · [(1) kernelsize=5 →](11-1-kernelsize-5.md)
