---
title: Print weight tensor shape
...
[← Print output shape](25-print-output-shape.md) · [Up: contents](index.md) · [Print total number of weights →](27-print-total-number-of-weights.md)
