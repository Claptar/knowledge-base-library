---
title: layer2 = nn.Conv1d(1, 4, kernelsize=5)
...
# layer2 = nn.Conv1d(1, 4, kernelsize=5)
...
[← print('\nkernelsize=5, padding=0, stride=1, length=10')](12-print-nkernelsize-5-padding-0-stride-1-length-10.md) · [Up: contents](index.md) · [print(layer2(torch.randn(2, 1, 10)).shape) →](14-print-layer2-torch-randn-2-1-10-shape.md)
