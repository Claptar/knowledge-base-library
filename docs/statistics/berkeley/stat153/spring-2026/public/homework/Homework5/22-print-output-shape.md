...
[← print("\nn weight params:", layer4.weight.numel())](21-print-nn-weight-params-layer4-weight-numel.md) · [Up: contents](index.md) · [Print weight tensor shape →](23-print-weight-tensor-shape.md)
