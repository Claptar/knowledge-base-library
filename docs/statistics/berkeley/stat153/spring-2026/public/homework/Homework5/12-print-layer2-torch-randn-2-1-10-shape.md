---
title: print(layer2(torch.randn(2, 1, 10)).shape)
...
[← layer2 = nn.Conv1d(1, 4, kernelsize=5)](11-layer2-nn-conv1d-1-4-kernelsize-5.md) · [Up: contents](index.md) · [(2) kernelsize=5, padding=2 →](13-2-kernelsize-5-padding-2.md)
