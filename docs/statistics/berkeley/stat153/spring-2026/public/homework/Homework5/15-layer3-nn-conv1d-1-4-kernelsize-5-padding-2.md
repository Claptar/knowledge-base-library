...
[← print('\nkernelsize=5, padding=2, stride=1, length=10')](14-print-nkernelsize-5-padding-2-stride-1-length-10.md) · [Up: contents](index.md) · [print(layer3(torch.randn(2, 1, 10)).shape) →](16-print-layer3-torch-randn-2-1-10-shape.md)
