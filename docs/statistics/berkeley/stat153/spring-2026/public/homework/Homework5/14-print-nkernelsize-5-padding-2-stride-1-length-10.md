---
title: print('\nkernelsize=5, padding=2, stride=1, length=10')
...
[← (2) kernelsize=5, padding=2](13-2-kernelsize-5-padding-2.md) · [Up: contents](index.md) · [layer3 = nn.Conv1d(1, 4, kernelsize=5, padding=2) →](15-layer3-nn-conv1d-1-4-kernelsize-5-padding-2.md)
