...
[← print('\nkernelsize=5, padding=0, stride=1, length=10')](10-print-nkernelsize-5-padding-0-stride-1-length-10.md) · [Up: contents](index.md) · [print(layer2(torch.randn(2, 1, 10)).shape) →](12-print-layer2-torch-randn-2-1-10-shape.md)
