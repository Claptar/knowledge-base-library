...
[← Uncomment one block at a time after making your prediction.](08-uncomment-one-block-at-a-time-after-making-your-prediction.md) · [Up: contents](index.md) · [print('\nkernelsize=5, padding=0, stride=1, length=10') →](10-print-nkernelsize-5-padding-0-stride-1-length-10.md)
