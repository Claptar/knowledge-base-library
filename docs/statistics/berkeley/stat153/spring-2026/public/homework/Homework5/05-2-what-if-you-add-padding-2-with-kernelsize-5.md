...
[← 1. What output shape do you expect if kernelsize is 5 instead of 3?](04-1-what-output-shape-do-you-expect-if-kernelsize-is-5-instead.md) · [Up: contents](index.md) · [3. What if the input has 3 channels instead of 1 (so x.shape = (2, 3, 10 →](06-3-what-if-the-input-has-3-channels-instead-of-1-so-x-shape-2.md)
