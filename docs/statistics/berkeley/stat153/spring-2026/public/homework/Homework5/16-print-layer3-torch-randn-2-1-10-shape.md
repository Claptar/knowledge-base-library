---
title: print(layer3(torch.randn(2, 1, 10)).shape)
...
[← layer3 = nn.Conv1d(1, 4, kernelsize=5, padding=2)](15-layer3-nn-conv1d-1-4-kernelsize-5-padding-2.md) · [Up: contents](index.md) · [(3) inchannels=3 →](17-3-inchannels-3.md)
