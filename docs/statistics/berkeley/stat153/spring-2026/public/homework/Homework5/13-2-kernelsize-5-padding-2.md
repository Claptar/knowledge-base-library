---
title: (2) kernelsize=5, padding=2
...
[← print(layer2(torch.randn(2, 1, 10)).shape)](12-print-layer2-torch-randn-2-1-10-shape.md) · [Up: contents](index.md) · [print('\nkernelsize=5, padding=2, stride=1, length=10') →](14-print-nkernelsize-5-padding-2-stride-1-length-10.md)
