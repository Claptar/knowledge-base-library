---
title: Fit trend filtering on all points but those in first fold. We are forcing it
...
[← Fit trend filtering on the entire data in order to grab the lambda sequence](07-fit-trend-filtering-on-the-entire-data-in-order-to-grab-the.md) · [Up: contents](index.md) · [to use the lambda sequence that we saved above →](09-to-use-the-lambda-sequence-that-we-saved-above.md)
