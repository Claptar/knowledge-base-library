...
[← Plot this broken regression fitted values along with linear model fitted values](19-plot-this-broken-regression-fitted-values-along-with-linear.md) · [Up: contents](index.md) · [this plot looks similar to the RSS plot →](21-this-plot-looks-similar-to-the-rss-plot.md)
