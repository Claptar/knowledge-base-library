...
[← Regression and Partial Correlation](02-regression-and-partial-correlation.md) · [Up: contents](index.md) · [Extract coefficients for the characteristic polynomial →](04-extract-coefficients-for-the-characteristic-polynomial.md)
