...
[Up: contents](index.md) · [trend = 'c' will fit the model yt = phi0 + \phi1 y{t-1} + \dots + \phip y{t-p} + \epsilont →](02-trend-c-will-fit-the-model-yt-phi0-phi1-y-t-1-dots-phip-y-t.md)
