---
title: 5 Multiplicative Seasonal ARMA Models
...
We can get a much more parsimonious model for this dataset by _combining_ the MA(1) model with a seasonal MA(1) model of period 12. Specifically, consider the model

_yt_ = (1 + Θ _B_<sup>12</sup> )(1 + _θB_ ) _ϵt_ = �1 + _θB_ + Θ _B_<sup>12</sup> + _θ_ Θ _B_<sup>13�</sup> _ϵt_ = _ϵt_ + _θϵt−_ 1 + Θ _ϵt−_ 12 + _θ_ Θ _ϵt−_ 13 _._
...
[← 4 Seasonal ARMA Models](04-4-seasonal-arma-models.md) · [Up: contents](index.md) · [6 SARIMA Models →](06-6-sarima-models.md)
