...
[← Below we plot the log(periodogram) and the fitted spectrum estimator on the same plot](03-below-we-plot-the-log-periodogram-and-the-fitted-spectrum-es.md) · [Up: contents](index.md) · [Plotting the tauj estimates (estimated spectrum) →](05-plotting-the-tauj-estimates-estimated-spectrum.md)
