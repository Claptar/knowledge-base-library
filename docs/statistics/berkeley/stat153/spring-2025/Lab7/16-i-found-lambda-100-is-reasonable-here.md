...
[← Plotting the tauj estimates (estimated spectrum)](15-plotting-the-tauj-estimates-estimated-spectrum.md) · [Up: contents](index.md) · [Below we plot the log(periodogram) and the fitted spectrum estimator on the same plot →](17-below-we-plot-the-log-periodogram-and-the-fitted-spectrum-es.md)
