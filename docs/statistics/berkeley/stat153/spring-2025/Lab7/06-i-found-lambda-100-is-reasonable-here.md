---
title: I found lambda = 100 is reasonable here
...
[← Plotting the tauj estimates (estimated spectrum)](05-plotting-the-tauj-estimates-estimated-spectrum.md) · [Up: contents](index.md) · [Below we plot the log(periodogram) and the fitted spectrum estimator on the same plot →](07-below-we-plot-the-log-periodogram-and-the-fitted-spectrum-es.md)
