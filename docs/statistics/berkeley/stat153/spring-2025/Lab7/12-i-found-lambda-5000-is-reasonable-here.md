...
[← Find peaks in the estimated spectrum](11-find-peaks-in-the-estimated-spectrum.md) · [Up: contents](index.md) · [Below we plot the log(periodogram) and the fitted spectrum estimator on the same plot →](13-below-we-plot-the-log-periodogram-and-the-fitted-spectrum-es.md)
