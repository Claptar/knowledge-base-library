...
Multiple linear regression of _Yt_ on  and other _t_ functions of  (such as powers, sinusoids etc) _t_ will fit more general functions to the data


on : Linear regression of _Yt_ 1, cos( _πt_ /6), sin( _πt_ /6)


~ _Yt_ 1, cos( _πt_ /6), sin( _πt_ /6), cos( _πt_ /3), sin( _πt_ /3)
