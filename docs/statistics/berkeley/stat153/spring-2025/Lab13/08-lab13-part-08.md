...
[← Define a loss function](07-define-a-loss-function.md) · [Up: contents](index.md) · [but is detached from the computation graph. →](09-but-is-detached-from-the-computation-graph.md)
