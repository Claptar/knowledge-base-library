...
[← Both these methods give similar but slightly different answers](06-both-these-methods-give-similar-but-slightly-different-answe.md) · [Up: contents](index.md) · [but the remaining estimates are almost the same. →](08-but-the-remaining-estimates-are-almost-the-same.md)
