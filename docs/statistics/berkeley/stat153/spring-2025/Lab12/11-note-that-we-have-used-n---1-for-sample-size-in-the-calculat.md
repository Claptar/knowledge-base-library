---
title: Note that we have used (n - 1) for sample size in the calculation for BIC
...
[← these are the forecasts for the differenced data](10-these-are-the-forecasts-for-the-differenced-data.md) · [Up: contents](index.md) · [Lab12 Part 12 — →](12-lab12-part-12.md)
