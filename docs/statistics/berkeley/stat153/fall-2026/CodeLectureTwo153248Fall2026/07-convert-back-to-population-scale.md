---
title: Convert back to population scale
...
[← Fitted and predicted values on the log scale](06-fitted-and-predicted-values-on-the-log-scale.md) · [Up: contents](index.md) · [Plot observed data, fitted values, and future predictions →](08-plot-observed-data-fitted-values-and-future-predictions.md)
