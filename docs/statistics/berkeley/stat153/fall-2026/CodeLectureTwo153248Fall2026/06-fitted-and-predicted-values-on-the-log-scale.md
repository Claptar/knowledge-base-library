---
title: Fitted and predicted values on the log scale
...
[← Design matrix for future observations](05-design-matrix-for-future-observations.md) · [Up: contents](index.md) · [Convert back to population scale →](07-convert-back-to-population-scale.md)
