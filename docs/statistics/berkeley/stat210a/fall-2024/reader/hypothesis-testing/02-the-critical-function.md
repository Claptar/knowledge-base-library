...
legend("topleft", col=c("black","blue"), c(expression(p[0](https://github.com/berkeley-stat210a/fall-2024/blob/812543bde50398a54db3044bf8ba7120189a4dfa/reader/z)),expression(p[theta[1]](z))))
```
