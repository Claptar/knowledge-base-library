...
source: https://github.com/berkeley-stat210a/fall-2024/blob/812543bde50398a54db3044bf8ba7120189a4dfa/reader/hypothesis-testing.qmd
source_file: sources/berkeley-stat210a/fall-2024/reader/hypothesis-testing.qmd
licence: CC BY 4.0
route: markdown
fidelity: lossless
...
**Source:** [`reader/hypothesis-testing.qmd`](https://github.com/berkeley-stat210a/fall-2024/blob/812543bde50398a54db3044bf8ba7120189a4dfa/reader/hypothesis-testing.qmd) · **Licence:** CC BY 4.0 · Converted 2026-09-14 from `.qmd` (lossless)
...
x <- 30:70
plot(x,dbinom(x,n,theta0), type="h", main = expression(paste("Binomial test ",(alpha==0.05))), xlab="X", ylab=expression(p[0.5](https://github.com/berkeley-stat210a/fall-2024/blob/812543bde50398a54db3044bf8ba7120189a4dfa/reader/X)), lwd=3)
...
[← The critical function](02-the-critical-function.md) · [Up: contents](index.md)
