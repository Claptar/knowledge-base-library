...
# t and F Distributions, Canonical and General Linear Models
...
1. [t and F Distributions](01-t-and-f-distributions.md)
2. [Canonical Linear Model](02-canonical-linear-model.md)
3. [General Linear Model](03-general-linear-model.md)
