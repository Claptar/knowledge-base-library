...
source: https://github.com/berkeley-stat210a/fall-2026/blob/7dc8f80da94dff74532d9e3923afdb16a255262d/reader/jamesstein.qmd
source_file: sources/berkeley-stat210a/fall-2026/reader/jamesstein.qmd
licence: CC BY 4.0
route: markdown
fidelity: lossless
...
$$Z = \frac{1}{\sigma\sqrt{n}} \sum_i X_i \sim N_d(\mu, I_d), \quad \text{for } \mu = \theta\sqrt{n}/\sigma$$ For
...
which was proved in [Lecture 10](../bayes-estimation/index.md). Plugging in $\hat\zeta_\text{UMVU}$ results in an estimator called the *James-Stein* estimator,
