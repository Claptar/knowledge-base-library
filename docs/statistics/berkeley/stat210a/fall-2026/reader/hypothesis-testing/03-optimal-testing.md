...
x <- 30:70
plot(x,dbinom(x,n,theta0), type="h", main = expression(paste("Binomial test ",(alpha==0.05))), xlab="X", ylab=expression(p[0.5](https://github.com/berkeley-stat210a/fall-2026/blob/7dc8f80da94dff74532d9e3923afdb16a255262d/reader/X)), lwd=3)
