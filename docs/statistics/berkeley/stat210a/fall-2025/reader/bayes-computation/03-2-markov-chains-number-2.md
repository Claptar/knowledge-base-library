---
title: 2 Markov chains {number="2"}
...
[← 1 Why Bayesian computation is difficult {number="1"}](02-1-why-bayesian-computation-is-difficult-number-1.md) · [Up: contents](index.md) · [3 The Gibbs sampler {number="3"} →](04-3-the-gibbs-sampler-number-3.md)
