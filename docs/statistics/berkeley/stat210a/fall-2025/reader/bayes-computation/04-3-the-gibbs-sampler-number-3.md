---
title: 3 The Gibbs sampler {number="3"}
...
[← 2 Markov chains {number="2"}](03-2-markov-chains-number-2.md) · [Up: contents](index.md) · [4 MCMC in practice {number="4"} →](05-4-mcmc-in-practice-number-4.md)
