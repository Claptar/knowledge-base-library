---
title: 1 Why Bayesian computation is difficult {number="1"}
...
[← Markov Chain Monte Carlo {#markov-chain-monte-carlo .title}](01-markov-chain-monte-carlo-markov-chain-monte-carlo-title.md) · [Up: contents](index.md) · [2 Markov chains {number="2"} →](03-2-markov-chains-number-2.md)
