...
2.  [Hypothesis Testing and the Neyman-Pearson Lemma](index.md)

# Hypothesis Testing and the Neyman-Pearson Lemma {#hypothesis-testing-and-the-neyman-pearson-lemma .title}
