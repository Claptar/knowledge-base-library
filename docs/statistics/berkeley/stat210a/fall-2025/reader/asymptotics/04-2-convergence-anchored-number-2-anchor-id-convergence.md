...
[← "True" Fisher information](03-true-fisher-information.md) · [Up: contents](index.md) · [3 Continuous Mapping Theorem {.anchored number="3" anchor-id="continuous-mapping-theorem"} →](05-3-continuous-mapping-theorem-anchored-number-3-anchor-id-con.md)
