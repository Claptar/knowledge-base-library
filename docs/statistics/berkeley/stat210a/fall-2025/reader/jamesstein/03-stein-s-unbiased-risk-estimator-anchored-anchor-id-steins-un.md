---
title: Stein’s Unbiased Risk Estimator {.anchored anchor-id="steins-unbiased-risk-estimator"}
...
# Stein’s Unbiased Risk Estimator {.anchored anchor-id="steins-unbiased-risk-estimator"}
...
### Stein’s Lemma {.anchored anchor-id="steins-lemma"}
...
### Stein’s unbaised risk estimator (SURE) {.anchored anchor-id="steins-unbaised-risk-estimator-sure"}
...
### Example: shrinking toward <span class="math inline">\$\\overline{X}\$</span> {.anchored anchor-id="example-shrinking-toward-overlinex"}
...
[← Gaussian sequence model {.anchored anchor-id="gaussian-sequence-model"}](02-gaussian-sequence-model-anchored-anchor-id-gaussian-sequence.md) · [Up: contents](index.md) · [Jamesstein Part 04 — →](04-jamesstein-part-04.md)
