---
title: Gaussian sequence model {.anchored anchor-id="gaussian-sequence-model"}
source: https://github.com/berkeley-stat210a/fall-2025/blob/5eb849a4924c34eb73e098cdfc812ffa8d806501/reader/jamesstein.html
source_file: sources/berkeley-stat210a/fall-2025/reader/jamesstein.html
licence: CC BY 4.0
route: pandoc-html
fidelity: good
...
# Gaussian sequence model {.anchored anchor-id="gaussian-sequence-model"}

**Source:** [`reader/jamesstein.html`](https://github.com/berkeley-stat210a/fall-2025/blob/5eb849a4924c34eb73e098cdfc812ffa8d806501/reader/jamesstein.html) · **Licence:** CC BY 4.0 · Converted 2026-09-14 from `.html` (good)
...
<span class="math display">\\$$Z = \\frac{1}{\\sigma\\sqrt{n}} \\sum\_i X\_i \\sim N\_d(\\mu, I\_d), \\quad \\text{for } \\mu = \\theta\\sqrt{n}/\\sigma\\$$</span> For simplicity we will discuss the “vanilla” version here, but we can always translate our results to the more general setting via this transformation.
...
### Bayes estimators {.anchored anchor-id="bayes-estimators"}
...
### Linear shrinkage estimators {.anchored anchor-id="linear-shrinkage-estimators"}
...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [Stein’s Unbiased Risk Estimator {.anchored anchor-id="steins-unbiased-risk-estimator"} →](03-stein-s-unbiased-risk-estimator-anchored-anchor-id-steins-un.md)
