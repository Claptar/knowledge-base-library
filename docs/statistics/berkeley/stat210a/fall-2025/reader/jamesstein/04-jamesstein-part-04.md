...
[← Stein’s Unbiased Risk Estimator {.anchored anchor-id="steins-unbiased-risk-estimator"}](03-stein-s-unbiased-risk-estimator-anchored-anchor-id-steins-un.md) · [Up: contents](index.md)
