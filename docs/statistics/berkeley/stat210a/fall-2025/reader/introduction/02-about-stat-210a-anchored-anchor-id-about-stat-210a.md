...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [Deductive vs inductive reasoning {.anchored anchor-id="deductive-vs-inductive-reasoning"} →](03-deductive-vs-inductive-reasoning-anchored-anchor-id-deductiv.md)
