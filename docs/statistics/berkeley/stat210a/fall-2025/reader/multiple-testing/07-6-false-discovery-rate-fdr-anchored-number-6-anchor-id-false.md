---
title: 6 False Discovery Rate (FDR) {.anchored number="6" anchor-id="false-discovery-rate-fdr"}
...
[← 5 Deduced Inference {.anchored number="5" anchor-id="deduced-inference"}](06-5-deduced-inference-anchored-number-5-anchor-id-deduced-infe.md) · [Up: contents](index.md) · [Multiple testing Part 08 — →](08-multiple-testing-part-08.md)
