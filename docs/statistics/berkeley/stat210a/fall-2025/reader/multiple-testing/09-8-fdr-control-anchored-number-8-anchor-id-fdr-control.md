---
title: 8 FDR Control {.anchored number="8" anchor-id="fdr-control"}
...
# 8 FDR Control {.anchored number="8" anchor-id="fdr-control"}
...
[← Multiple testing Part 08 —](08-multiple-testing-part-08.md) · [Up: contents](index.md)
