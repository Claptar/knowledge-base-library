---
title: Multiple testing Part 08 —
...
[← 6 False Discovery Rate (FDR) {.anchored number="6" anchor-id="false-discovery-rate-fdr"}](07-6-false-discovery-rate-fdr-anchored-number-6-anchor-id-false.md) · [Up: contents](index.md) · [8 FDR Control {.anchored number="8" anchor-id="fdr-control"} →](09-8-fdr-control-anchored-number-8-anchor-id-fdr-control.md)
