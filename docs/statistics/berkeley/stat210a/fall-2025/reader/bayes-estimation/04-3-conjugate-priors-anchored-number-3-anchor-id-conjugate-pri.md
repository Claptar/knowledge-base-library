---
title: 3 Conjugate priors {.anchored number="3" anchor-id="conjugate-priors"}
...
# 3 Conjugate priors {.anchored number="3" anchor-id="conjugate-priors"}
...
[← 2 Bayes estimator {.anchored number="2" anchor-id="bayes-estimator"}](03-2-bayes-estimator-anchored-number-2-anchor-id-bayes-estimato.md) · [Up: contents](index.md)
