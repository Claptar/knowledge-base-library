...
[← Examples {.anchored anchor-id="examples"}](06-examples-anchored-anchor-id-examples.md) · [Up: contents](index.md) · [Minimal sufficiency {.anchored anchor-id="minimal-sufficiency"} →](08-minimal-sufficiency-anchored-anchor-id-minimal-sufficiency.md)
