---
title: 2 Ancillarity {.anchored number="2" anchor-id="ancillarity"}
...
# 2 Ancillarity {.anchored number="2" anchor-id="ancillarity"}
...
We’ve spent a lot of time discussing sufficient statistics, which are statistics that carry *all* of the information about <span class="math inline">\$\\theta\$</span>. Our next definition describes a type of statistic that carries *no* information about the parameter.
...
[← 1 Completeness {.anchored number="1" anchor-id="completeness"}](02-1-completeness-anchored-number-1-anchor-id-completeness.md) · [Up: contents](index.md) · [3 Basu’s Theorem {.anchored number="3" anchor-id="basus-theorem"} →](04-3-basu-s-theorem-anchored-number-3-anchor-id-basus-theorem.md)
