...
**Example 1 (Counting measure):** If <span class="math inline">\$\\cX\$</span> is countable, e.g. <span class="math inline">\$\\cX = \\mathbb{Z}\$</span>, then a natural measure is the *counting measure* <span class="math inline">\$\\#(A)\$</span>*,* which simply counts the number of points in a subset <span class="math inline">\$A\$</span>. For example, <span class="math inline">\$\\#(\\{0,1\\}) = 2\$</span>, and <span class="math inline">\$\\#(\\{2,4,6,8,\\ldots\\}) = \\infty\$</span> .
...
**Example:** If <span class="math inline">\$\\cX\$</span> is countable we commonly take <span class="math inline">\$\\cF\$</span> to be the entire power set.
...
### Push-forward measure {.anchored anchor-id="push-forward-measure"}

If we have a measure space <span class="math inline">\$(\\cX, \\cF, \\mu)\$</span> and a (nice enough) function <span class="math inline">\$f\$</span> from <span class="math inline">\$\\mathcal{X}\$</span> to some other sample space <span class="math inline">\$\\mathcal{Y}\$</span>, we can define a new measure <span class="math inline">\$\\nu\$</span> on <span class="math inline">\$\\mathcal{Y}\$</span> where <span class="math inline">\$\\nu(B)\$</span> is the amount of <span class="math inline">\$\\mu\$</span> measure that <span class="math inline">\$f\$</span> maps into <span class="math inline">\$B\$</span>. That is, <span class="math inline">\$\\nu(B) = \\mu(f^{-1}(B))\$</span>, where <span class="math inline">\$f^{-1}(B) = \\{x\\in \\cX:\\; f(x) \\in B\\}\$</span> is the preimage of <span class="math inline">\$B\$</span> in <span class="math inline">\$\\cX\$</span>; more compactly, we can write <span class="math inline">\$\\nu = \\mu \\circ f^{-1}\$</span>. This new measure <span class="math inline">\$\\nu\$</span> is called a *push-forward* measure.

The push-forward operation defines the probability distribution for a function of a random variable.

**Example 4: (Gaussian positive part)** Define <span class="math inline">\$Y = \\max\\{0,Z\\}\$</span> and let <span class="math inline">\$P\_Y\$</span> represent its probability distribution. Then <span class="math display">\\$$ P\_Y(B) = \\mathbb{P}(Y \\in B) = \\mathbb{P}(Z \\in f^{-1}(B)) \\$$</span> is the push-forward of <span class="math inline">\$P\_Z\$</span> through the function <span class="math inline">\$f(z) = \\max\\{0,z\\}\$</span>.
...
[← Probability as a measure](03-probability-as-a-measure.md) · [Up: contents](index.md) · [Integrals →](05-integrals.md)
