...
If we do not specify what <span class="math inline">\$\\mu\$</span> is, it is assumed to be the Lebesgue measure; that is, if we say <span class="math inline">\$P\$</span> is *absolutely continuous* without elaborating further, we mean <span class="math inline">\$P \\ll \\lambda\$</span>.
...
[← Integrals {.anchored anchor-id="integrals"}](05-integrals-anchored-anchor-id-integrals.md) · [Up: contents](index.md) · [Probability Part 07 — →](07-probability-part-07.md)
