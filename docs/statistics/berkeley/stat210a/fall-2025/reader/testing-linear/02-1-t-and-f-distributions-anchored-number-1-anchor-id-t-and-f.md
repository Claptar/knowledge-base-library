---
title: 1 t and F Distributions {.anchored number="1" anchor-id="t-and-f-distributions"}
...
# 1 t and F Distributions {.anchored number="1" anchor-id="t-and-f-distributions"}
...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [2 Canonical Linear Model {.anchored number="2" anchor-id="canonical-linear-model"} →](03-2-canonical-linear-model-anchored-number-2-anchor-id-canonic.md)
