---
title: Minimax Estimation {#minimax-estimation .title}
...
[Up: contents](index.md) · [1 Minimax risk and estimator {number="1"} →](02-1-minimax-risk-and-estimator-number-1.md)
