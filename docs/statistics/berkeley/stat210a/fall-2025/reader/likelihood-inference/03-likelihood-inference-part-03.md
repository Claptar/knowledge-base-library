...
[← 1 Likelihood-Based Inference {.anchored number="1" anchor-id="likelihood-based-inference"}](02-1-likelihood-based-inference-anchored-number-1-anchor-id-lik.md) · [Up: contents](index.md) · [3 Score Test {.anchored number="3" anchor-id="score-test"} →](04-3-score-test-anchored-number-3-anchor-id-score-test.md)
