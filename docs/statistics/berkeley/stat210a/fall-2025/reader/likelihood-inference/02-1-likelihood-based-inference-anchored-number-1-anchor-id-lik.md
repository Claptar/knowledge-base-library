---
title: 1 Likelihood-Based Inference {.anchored number="1" anchor-id="likelihood-based-inference"}
...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [Likelihood inference Part 03 — →](03-likelihood-inference-part-03.md)
