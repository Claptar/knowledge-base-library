...
Link to the [data](../data.md).

## <span class="math inline">\$\\LaTeX\$</span> {.anchored anchor-id="latex"}

Here is some <span class="math inline">\$\\LaTeX\$</span>. <span class="math display">\\$$ \\theta = 7 \\$$</span>

## Evaluated Python code {.anchored anchor-id="evaluated-python-code"}
...
## Callout {.anchored anchor-id="callout"}
