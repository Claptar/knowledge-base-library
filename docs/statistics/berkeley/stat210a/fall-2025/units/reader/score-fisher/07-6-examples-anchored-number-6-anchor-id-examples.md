---
title: 6 Examples {.anchored number="6" anchor-id="examples"}
...
# 6 Examples {.anchored number="6" anchor-id="examples"}
...
[← 5 Cramér-Rao Lower Bound {.anchored number="5" anchor-id="cramér-rao-lower-bound"}](06-5-cramér-rao-lower-bound-anchored-number-5-anchor-id-cramér.md) · [Up: contents](index.md) · [7 Efficiency {.anchored number="7" anchor-id="efficiency"} →](08-7-efficiency-anchored-number-7-anchor-id-efficiency.md)
