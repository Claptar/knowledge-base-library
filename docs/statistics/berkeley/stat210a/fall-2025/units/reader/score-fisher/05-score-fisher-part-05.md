...
[← 3 Score Function {.anchored number="3" anchor-id="score-function"}](04-3-score-function-anchored-number-3-anchor-id-score-function.md) · [Up: contents](index.md) · [5 Cramér-Rao Lower Bound {.anchored number="5" anchor-id="cramér-rao-lower-bound"} →](06-5-cramér-rao-lower-bound-anchored-number-5-anchor-id-cramér.md)
