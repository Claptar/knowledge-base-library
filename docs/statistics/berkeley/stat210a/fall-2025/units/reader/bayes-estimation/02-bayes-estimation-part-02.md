...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [2 Special Cases and Examples {.anchored number="2" anchor-id="special-cases-and-examples"} →](03-2-special-cases-and-examples-anchored-number-2-anchor-id-spe.md)
