---
title: Multiple testing Part 03 —
...
[← 1 Multiple Testing {.anchored number="1" anchor-id="multiple-testing"}](02-1-multiple-testing-anchored-number-1-anchor-id-multiple-test.md) · [Up: contents](index.md) · [3 Bonferroni Correction {.anchored number="3" anchor-id="bonferroni-correction"} →](04-3-bonferroni-correction-anchored-number-3-anchor-id-bonferro.md)
