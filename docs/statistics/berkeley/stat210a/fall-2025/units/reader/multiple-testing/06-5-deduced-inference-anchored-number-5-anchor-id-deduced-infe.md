---
title: 5 Deduced Inference {.anchored number="5" anchor-id="deduced-inference"}
...
# 5 Deduced Inference {.anchored number="5" anchor-id="deduced-inference"}
...
[← 4 Testing with Dependence {.anchored number="4" anchor-id="testing-with-dependence"}](05-4-testing-with-dependence-anchored-number-4-anchor-id-testin.md) · [Up: contents](index.md) · [6 False Discovery Rate (FDR) {.anchored number="6" anchor-id="false-discovery-rate-fdr"} →](07-6-false-discovery-rate-fdr-anchored-number-6-anchor-id-false.md)
