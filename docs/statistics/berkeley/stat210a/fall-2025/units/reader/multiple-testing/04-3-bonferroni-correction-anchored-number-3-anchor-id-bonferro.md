---
title: 3 Bonferroni Correction {.anchored number="3" anchor-id="bonferroni-correction"}
...
[← Multiple testing Part 03 —](03-multiple-testing-part-03.md) · [Up: contents](index.md) · [4 Testing with Dependence {.anchored number="4" anchor-id="testing-with-dependence"} →](05-4-testing-with-dependence-anchored-number-4-anchor-id-testin.md)
