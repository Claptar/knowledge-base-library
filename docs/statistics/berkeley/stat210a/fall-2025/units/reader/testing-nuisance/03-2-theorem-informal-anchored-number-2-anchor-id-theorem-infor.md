---
title: 2 Theorem (Informal) {.anchored number="2" anchor-id="theorem-informal"}
...
# 2 Theorem (Informal) {.anchored number="2" anchor-id="theorem-informal"}
...
[← 1 Nuisance Parameters {.anchored number="1" anchor-id="nuisance-parameters"}](02-1-nuisance-parameters-anchored-number-1-anchor-id-nuisance-p.md) · [Up: contents](index.md) · [3 Proof Sketch {.anchored number="3" anchor-id="proof-sketch"} →](04-3-proof-sketch-anchored-number-3-anchor-id-proof-sketch.md)
