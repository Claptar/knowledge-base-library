---
title: 3 Proof Sketch {.anchored number="3" anchor-id="proof-sketch"}
...
# 3 Proof Sketch {.anchored number="3" anchor-id="proof-sketch"}
...
[← 2 Theorem (Informal) {.anchored number="2" anchor-id="theorem-informal"}](03-2-theorem-informal-anchored-number-2-anchor-id-theorem-infor.md) · [Up: contents](index.md) · [4 Permutation Tests {.anchored number="4" anchor-id="permutation-tests"} →](05-4-permutation-tests-anchored-number-4-anchor-id-permutation.md)
