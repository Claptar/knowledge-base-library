---
title: 1 Nuisance Parameters {.anchored number="1" anchor-id="nuisance-parameters"}
...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [2 Theorem (Informal) {.anchored number="2" anchor-id="theorem-informal"} →](03-2-theorem-informal-anchored-number-2-anchor-id-theorem-infor.md)
