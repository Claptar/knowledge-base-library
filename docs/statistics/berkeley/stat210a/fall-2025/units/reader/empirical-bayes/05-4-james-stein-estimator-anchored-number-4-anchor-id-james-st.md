---
title: 4 James-Stein Estimator {.anchored number="4" anchor-id="james-stein-estimator"}
...
# 4 James-Stein Estimator {.anchored number="4" anchor-id="james-stein-estimator"}
...
[← 3 Empirical Bayes {.anchored number="3" anchor-id="empirical-bayes"}](04-3-empirical-bayes-anchored-number-3-anchor-id-empirical-baye.md) · [Up: contents](index.md) · [5 Stein’s Lemma {.anchored number="5" anchor-id="steins-lemma-1"} →](06-5-stein-s-lemma-anchored-number-5-anchor-id-steins-lemma-1.md)
