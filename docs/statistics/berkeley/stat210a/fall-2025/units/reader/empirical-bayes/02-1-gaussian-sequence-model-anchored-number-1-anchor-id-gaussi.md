---
title: 1 Gaussian sequence model {.anchored number="1" anchor-id="gaussian-sequence-model"}
...
# 1 Gaussian sequence model {.anchored number="1" anchor-id="gaussian-sequence-model"}
...
<span class="math display">\\$$L(\\theta, d) = \\\|\\delta(X) - \\theta\\\|\\^2 = \\sum\\\_j (\\delta\\\_j(X) - \\theta\\\_j)\\^2\\$$</span>
...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [Empirical bayes Part 03 — →](03-empirical-bayes-part-03.md)
