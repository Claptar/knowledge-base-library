---
title: 1 Minimax Risk Estimator {.anchored number="1" anchor-id="minimax-risk-estimator"}
...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [2 Least Favorable Priors {.anchored number="2" anchor-id="least-favorable-priors"} →](03-2-least-favorable-priors-anchored-number-2-anchor-id-least-f.md)
