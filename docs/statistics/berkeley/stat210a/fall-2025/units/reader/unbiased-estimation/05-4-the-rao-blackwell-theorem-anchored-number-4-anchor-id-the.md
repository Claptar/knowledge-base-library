---
title: 4 The Rao-Blackwell Theorem {.anchored number="4" anchor-id="the-rao-blackwell-theorem"}
...
# 4 The Rao-Blackwell Theorem {.anchored number="4" anchor-id="the-rao-blackwell-theorem"}
...
[← 3 Convex Loss Functions {.anchored number="3" anchor-id="convex-loss-functions"}](04-3-convex-loss-functions-anchored-number-3-anchor-id-convex-l.md) · [Up: contents](index.md) · [5 UMVU estimators {.anchored number="5" anchor-id="umvu-estimators"} →](06-5-umvu-estimators-anchored-number-5-anchor-id-umvu-estimator.md)
