---
title: 3 Convex Loss Functions {.anchored number="3" anchor-id="convex-loss-functions"}
...
# 3 Convex Loss Functions {.anchored number="3" anchor-id="convex-loss-functions"}
...
We say a loss function <span class="math inline">\$L(\\theta, d)\$</span> is (strictly) convex if is (strictly) convex as a function of the estimate <span class="math inline">\$d\$</span>, its second argument, holding the parameter <span class="math inline">\$\\theta\$</span> fixed.
...
[← Unbiased estimation Part 03 —](03-unbiased-estimation-part-03.md) · [Up: contents](index.md) · [4 The Rao-Blackwell Theorem {.anchored number="4" anchor-id="the-rao-blackwell-theorem"} →](05-4-the-rao-blackwell-theorem-anchored-number-4-anchor-id-the.md)
