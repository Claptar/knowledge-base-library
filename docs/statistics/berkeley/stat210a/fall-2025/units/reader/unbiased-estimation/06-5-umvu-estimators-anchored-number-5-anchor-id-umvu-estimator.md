---
title: 5 UMVU estimators {.anchored number="5" anchor-id="umvu-estimators"}
...
# 5 UMVU estimators {.anchored number="5" anchor-id="umvu-estimators"}
...
[← 4 The Rao-Blackwell Theorem {.anchored number="4" anchor-id="the-rao-blackwell-theorem"}](05-4-the-rao-blackwell-theorem-anchored-number-4-anchor-id-the.md) · [Up: contents](index.md) · [6 Finding the UMVUE {.anchored number="6" anchor-id="finding-the-umvue"} →](07-6-finding-the-umvue-anchored-number-6-anchor-id-finding-the.md)
