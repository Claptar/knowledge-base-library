---
title: 3 Continuous Mapping Theorem {.anchored number="3" anchor-id="continuous-mapping-theorem"}
...
[← 2 Convergence {.anchored number="2" anchor-id="convergence"}](04-2-convergence-anchored-number-2-anchor-id-convergence.md) · [Up: contents](index.md) · [4 Slutsky’s Theorem {.anchored number="4" anchor-id="slutskys-theorem"} →](06-4-slutsky-s-theorem-anchored-number-4-anchor-id-slutskys-the.md)
