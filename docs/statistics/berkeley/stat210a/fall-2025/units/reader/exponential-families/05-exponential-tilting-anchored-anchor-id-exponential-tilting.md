---
title: Exponential tilting {.anchored anchor-id="exponential-tilting"}
...
[← Other parameterizations {.anchored anchor-id="other-parameterizations"}](04-other-parameterizations-anchored-anchor-id-other-parameteriz.md) · [Up: contents](index.md) · [Exponential families Part 06 — →](06-exponential-families-part-06.md)
