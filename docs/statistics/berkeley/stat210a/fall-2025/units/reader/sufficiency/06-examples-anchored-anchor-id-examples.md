...
[← Statement for general \$\\cX\$ {.anchored anchor-id="statement-for-general-cx"}](05-statement-for-general-anchored-anchor-id-statement-for-gener.md) · [Up: contents](index.md) · [Interpretations of sufficiency {.anchored anchor-id="interpretations-of-sufficiency"} →](07-interpretations-of-sufficiency-anchored-anchor-id-interpreta.md)
