---
title: 4 Empirical Bayes {.anchored number="4" anchor-id="empirical-bayes"}
...
# 4 Empirical Bayes {.anchored number="4" anchor-id="empirical-bayes"}
...
[← 3 Gibbs Sampler {.anchored number="3" anchor-id="gibbs-sampler"}](04-3-gibbs-sampler-anchored-number-3-anchor-id-gibbs-sampler.md) · [Up: contents](index.md)
