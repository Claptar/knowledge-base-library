---
title: 3 Gibbs Sampler {.anchored number="3" anchor-id="gibbs-sampler"}
...
# 3 Gibbs Sampler {.anchored number="3" anchor-id="gibbs-sampler"}
...
[← Hierarchical bayes Part 03 —](03-hierarchical-bayes-part-03.md) · [Up: contents](index.md) · [4 Empirical Bayes {.anchored number="4" anchor-id="empirical-bayes"} →](05-4-empirical-bayes-anchored-number-4-anchor-id-empirical-baye.md)
