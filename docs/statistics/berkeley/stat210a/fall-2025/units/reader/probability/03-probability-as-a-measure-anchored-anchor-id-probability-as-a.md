---
title: Probability as a measure {.anchored anchor-id="probability-as-a-measure"}
...
# Probability as a measure {.anchored anchor-id="probability-as-a-measure"}
...
[← What is a probability? {.anchored anchor-id="what-is-a-probability"}](02-what-is-a-probability-anchored-anchor-id-what-is-a-probabili.md) · [Up: contents](index.md) · [Measures {.anchored anchor-id="measures"} →](04-measures-anchored-anchor-id-measures.md)
