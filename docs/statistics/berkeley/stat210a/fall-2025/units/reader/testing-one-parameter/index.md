...
2. [Testing one parameter Part 02 —](02-testing-one-parameter-part-02.md)
3. [2 One-sided testing {.anchored number="2" anchor-id="one-sided-testing"}](03-2-one-sided-testing-anchored-number-2-anchor-id-one-sided-te.md)
4. [3 Two-sided alternatives {.anchored number="3" anchor-id="two-sided-alternatives"}](04-3-two-sided-alternatives-anchored-number-3-anchor-id-two-sid.md)
