---
title: 1 p-Values {.anchored number="1" anchor-id="p-values"}
...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [2 Confidence Regions {.anchored number="2" anchor-id="confidence-regions"} →](03-2-confidence-regions-anchored-number-2-anchor-id-confidence.md)
