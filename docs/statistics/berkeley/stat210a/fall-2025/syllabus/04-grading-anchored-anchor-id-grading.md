---
title: Grading {.anchored anchor-id="grading"}
...
**Drop policy:** We will drop your lowest two homework grades and your lowest three quiz grades. These drops are intended to cover eventualities like excused absences, medical issues, and emergencies, but there is no need to justify to us why you are taking them; they are unrestricted. If you need to drop an additional homework or quiz for some reason, after you have used up your allotted ones, it may be possible as long as you have documented your need for the additional drop as well as the drops you have already used.
...
[← References {.anchored anchor-id="references"}](03-references-anchored-anchor-id-references.md) · [Up: contents](index.md) · [Accommodations {.anchored anchor-id="accommodations"} →](05-accommodations-anchored-anchor-id-accommodations.md)
