---
title: “Conduct the experiment” {.anchored anchor-id="conduct-the-experiment"}
...
# “Conduct the experiment” {.anchored anchor-id="conduct-the-experiment"}
...
[← In a world where… {.anchored anchor-id="in-a-world-where"}](02-in-a-world-where-anchored-anchor-id-in-a-world-where.md) · [Up: contents](index.md) · [Code Part 04 — →](04-code-part-04.md)
