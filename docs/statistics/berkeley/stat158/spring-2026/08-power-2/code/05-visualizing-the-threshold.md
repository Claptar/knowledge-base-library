---
title: Visualizing the threshold
...
[← Find Sampling Distribution under \$H\0\$](04-find-sampling-distribution-under.md) · [Up: contents](index.md) · [Find Sampling Distribution under \$H\A\$ →](06-find-sampling-distribution-under.md)
