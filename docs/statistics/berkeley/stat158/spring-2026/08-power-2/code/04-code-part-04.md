...
[← “Conduct the experiment” {.anchored anchor-id="conduct-the-experiment"}](03-conduct-the-experiment-anchored-anchor-id-conduct-the-experi.md) · [Up: contents](index.md) · [Visualizing the threshold {.anchored anchor-id="visualizing-the-threshold"} →](05-visualizing-the-threshold-anchored-anchor-id-visualizing-the.md)
