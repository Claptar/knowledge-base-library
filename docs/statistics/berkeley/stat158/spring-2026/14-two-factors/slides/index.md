---
title: Designs with Two Factors
...
1. [Designs with Two Factors](01-designs-with-two-factors.md)
2. [A Linear Model](02-a-linear-model.md)
3. [Study: Battery Lifetime](03-study-battery-lifetime.md)
