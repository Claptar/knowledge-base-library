...
ggplot(group_means, aes(x = time,
  ...
  geom_line(lwd = 2) +
  facet_wrap(vars(hard), labeller = label_both) +
  theme_bw()
```
...
[← Time and Pressure and Hardness](11-time-and-pressure-and-hardness.md) · [Up: contents](index.md) · [Modeling →](13-modeling.md)
