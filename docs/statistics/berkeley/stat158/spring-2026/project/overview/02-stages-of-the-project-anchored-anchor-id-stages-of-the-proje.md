---
title: Stages of the Project {.anchored anchor-id="stages-of-the-project"}
...
# Stages of the Project {.anchored anchor-id="stages-of-the-project"}
...
#### Stage 1: Initial Proposal {.anchored anchor-id="stage-1-initial-proposal"}
...
#### Stage 2: Design Proposal {.anchored anchor-id="stage-2-design-proposal"}
...
1.  A replicated Latin Squares design (only one factor of interest necessary, but at least 4 levels for the factor): repeated LS$$1$$
2.  A Split Plot / Repeated Measures design (only one factor of interest necessary for a block, and one for subunits within block): SP/RM$$1,1$$
3.  A Complete Block design or Generalized Complete Block Design with at least two factors of interest: (CB$$2$$)
4.  A basic factorial design with at least 3 factors of interest, with at least one factor with more than levels (&gt;2) and relevant contrasts between the levels beyond all pairwise.
...
#### Stage 3: Protocol {.anchored anchor-id="stage-3-protocol"}
...
#### Stage 4: Experiment {.anchored anchor-id="stage-4-experiment"}
...
#### Stage 5: Final Report {.anchored anchor-id="stage-5-final-report"}
...
#### Stage 6: Self-evaluation {.anchored anchor-id="stage-6-self-evaluation"}
...
[← Guidelines for the experiment {.anchored anchor-id="guidelines-for-the-experiment"}](01-guidelines-for-the-experiment-anchored-anchor-id-guidelines.md) · [Up: contents](index.md) · [Overview Part 03 — →](03-overview-part-03.md)
