...
[← Introduction](01-introduction.md) · [Up: contents](index.md) · [Calculating the sampling distribution →](03-calculating-the-sampling-distribution.md)
