---
title: berkeley stat158 · spring 2026
source: https://github.com/berkeley-stat158/spring-2026.git
licence: unresolved
converted: 2026-09-14
---

# berkeley stat158 · spring 2026

Converted material from [https://github.com/berkeley-stat158/spring-2026.git](https://github.com/berkeley-stat158/spring-2026.git).
...
- [Ps](03-potential-outcomes/ps.md)

### 04-sampling-distributions

- **4. Sampling Distributions Starter**
    - [Whileto'reWaiting](04-sampling-distributions/4. Sampling Distributions Starter/01-whileto-rewaiting.md)
...
- **5. Testing Starter**
    - [Under what conditions will the sampling distribution of -% be 1)Normal? B)t ?](05-testing/5. Testing Starter/01-under-what-conditions-will-the-sampling-distribution-of---be.md)
...
- **code**
    ...
    - [replicate the anchor sched 20 times and stack them on top of one another](05-testing/code/05-replicate-the-anchor-sched-20-times-and-stack-them-on-top-of.md)
    - [add the unique permutations as a new column and find yi, the observed responses](05-testing/code/06-add-the-unique-permutations-as-a-new-column-and-find-yi-the.md)
    - [calculate ATE-hat for every partition](05-testing/code/07-calculate-ate-hat-for-every-partition.md)
- [Ps](05-testing/ps.md)

### 06-model-based-inference

- **6. Model-Based Inference Starter**
    - [Gals](06-model-based-inference/6. Model-Based Inference Starter/01-gals.md)
    - [Gals](06-model-based-inference/6. Model-Based Inference Starter/02-gals.md)
    - [Gals](06-model-based-inference/6. Model-Based Inference Starter/03-gals.md)

### 07-power-1

- [7. Power I Starter](07-power-1/7. Power I Starter.md)
...
- [11. One Factor Starter](11-one-factor/11. One Factor Starter.md)
...
- **slides**
    ...
    - [Time and Pressure](16-higher-order-effects/slides/05-time-and-pressure.md)
    - [Time and Hardness](16-higher-order-effects/slides/06-time-and-hardness.md)
    - [Time and Hardness](16-higher-order-effects/slides/07-time-and-hardness.md)
    - [Pressure and Hardness](16-higher-order-effects/slides/08-pressure-and-hardness.md)
    - [Pressure and Hardness](16-higher-order-effects/slides/09-pressure-and-hardness.md)
    - [Time and Pressure and Hardness](16-higher-order-effects/slides/10-time-and-pressure-and-hardness.md)
    - [Time and Pressure and Hardness](16-higher-order-effects/slides/11-time-and-pressure-and-hardness.md)
    - [Time and Pressure and Hardness](16-higher-order-effects/slides/12-time-and-pressure-and-hardness.md)
    - [Modeling](16-higher-order-effects/slides/13-modeling.md)
...
- **slides**
    ...
    - [Inference](19-blocking/slides/05-inference.md)
...
- **ws**
    - [Design I](23-comparing-designs/ws/01-design-i.md)
    - [Design II](23-comparing-designs/ws/02-design-ii.md)
    - [Design III](23-comparing-designs/ws/03-design-iii.md)
    - [Design III, continued](23-comparing-designs/ws/04-design-iii-continued.md)
...
- **slides**
    ...
    - [calculate beta](27-sequential-analysis/slides/05-calculate-beta.md)
    - [Use in Industry and Research](27-sequential-analysis/slides/06-use-in-industry-and-research.md)
    - [Confidence Sequences](27-sequential-analysis/slides/07-confidence-sequences.md)
    - [--- Parameters ---](27-sequential-analysis/slides/08-----parameters.md)
    - [Group Sequential Designs](27-sequential-analysis/slides/09-group-sequential-designs.md)
    - [5 equally-spaced interim analyses with O'Brien-Fleming spending](27-sequential-analysis/slides/10-5-equally-spaced-interim-analyses-with-o-brien-fleming-spend.md)
    - [Conclusion](27-sequential-analysis/slides/11-conclusion.md)
...
- **slides**
    ...
    - [calculate beta](27-sequential-analysis-2/slides/05-calculate-beta.md)
    - [Use in Industry and Research](27-sequential-analysis-2/slides/06-use-in-industry-and-research.md)
    - [Confidence Sequences](27-sequential-analysis-2/slides/07-confidence-sequences.md)
    - [--- Parameters ---](27-sequential-analysis-2/slides/08-----parameters.md)
    - [Group Sequential Designs](27-sequential-analysis-2/slides/09-group-sequential-designs.md)
    - [5 equally-spaced interim analyses with O'Brien-Fleming spending](27-sequential-analysis-2/slides/10-5-equally-spaced-interim-analyses-with-o-brien-fleming-spend.md)
    - [Conclusion](27-sequential-analysis-2/slides/11-conclusion.md)
...
- **slides**
    ...
    - [students in untreated households](32-interference-2/slides/05-students-in-untreated-households.md)
    - [Case Studies](32-interference-2/slides/06-case-studies.md)
...
- **slides**
    - [Study: Meadowfoam](35-regression/slides/01-study-meadowfoam.md)
    - [Slides Part 02 —](35-regression/slides/02-slides-part-02.md)
    - [A model for a categorical and continuous effect (ANCOVA)](35-regression/slides/03-a-model-for-a-categorical-and-continuous-effect-ancova.md)
...
- **2025-final-exam**
    - [2025 final exam Part 01 —](37-wrap-up/2025-final-exam/01-2025-final-exam-part-01.md)
    - [Identify the Design](37-wrap-up/2025-final-exam/02-identify-the-design.md)
    - [Short Answer](37-wrap-up/2025-final-exam/03-short-answer.md)
    - [Study 1: Burn Treatment](37-wrap-up/2025-final-exam/04-study-1-burn-treatment.md)
    - [Study 2: Washing Bacteria](37-wrap-up/2025-final-exam/05-study-2-washing-bacteria.md)
    - [Study 3: The Low Carb Diet](37-wrap-up/2025-final-exam/06-study-3-the-low-carb-diet.md)
    - [Study 4: Teaching AI to Teach](37-wrap-up/2025-final-exam/07-study-4-teaching-ai-to-teach.md)
    - [Scratch Paper](37-wrap-up/2025-final-exam/08-scratch-paper.md)
- **Midterm Review Topics List**
    - [Components of an Experiment](37-wrap-up/Midterm Review Topics List/01-components-of-an-experiment.md)
    - [Inference and Testing](37-wrap-up/Midterm Review Topics List/02-inference-and-testing.md)
    - [Power](37-wrap-up/Midterm Review Topics List/03-power.md)
...
- **slides**
    ...
    - [Big Ideas](37-wrap-up/slides/05-big-ideas.md)
- [Ws](37-wrap-up/ws.md)

### labs/01-components-and-eda

- **lab**
    - [Introduction](labs/01-components-and-eda/lab/01-introduction.md)
    - [load tidyverse (includes readr for CSVs)](labs/01-components-and-eda/lab/02-load-tidyverse-includes-readr-for-csvs.md)
    - [load the data into R](labs/01-components-and-eda/lab/03-load-the-data-into-r.md)
- **lab1**
    - [Introduction](labs/01-components-and-eda/lab1/01-introduction.md)
    - [load tidyverse (includes readr for CSVs)](labs/01-components-and-eda/lab1/02-load-tidyverse-includes-readr-for-csvs.md)
    - [load the data into R](labs/01-components-and-eda/lab1/03-load-the-data-into-r.md)

### labs/02-randomization-tests

- **lab**
    - [Introduction](labs/02-randomization-tests/lab/01-introduction.md)
    - [The Experiment](labs/02-randomization-tests/lab/02-the-experiment.md)
    - [Conducting Your Own Experiment](labs/02-randomization-tests/lab/03-conducting-your-own-experiment.md)
    - [Data Analysis](labs/02-randomization-tests/lab/04-data-analysis.md)
    - [Statistical tests](labs/02-randomization-tests/lab/05-statistical-tests.md)
    - [Non-parametric Methods: Randomization Tests](labs/02-randomization-tests/lab/06-non-parametric-methods-randomization-tests.md)
    - [Model-based Inference: The Z-Test](labs/02-randomization-tests/lab/07-model-based-inference-the-z-test.md)

### labs/03-power-and-extrapolation

- **lab**
    - [Introduction](labs/03-power-and-extrapolation/lab/01-introduction.md)
    - [The Experiments](labs/03-power-and-extrapolation/lab/02-the-experiments.md)
    - [A Third Study](labs/03-power-and-extrapolation/lab/03-a-third-study.md)
    - [Data Analysis](labs/03-power-and-extrapolation/lab/04-data-analysis.md)
    - [Lab Part 05 —](labs/03-power-and-extrapolation/lab/05-lab-part-05.md)
    - [Repeat for other two subgroups](labs/03-power-and-extrapolation/lab/06-repeat-for-other-two-subgroups.md)
...
- [Problem Set 1](problem-sets/ps1.md)
- [Problem Set 2](problem-sets/ps2.md)
- [Problem Set 3](problem-sets/ps3.md)
- [Problem Set 4](problem-sets/ps4.md)
- **ps5**
    - [Introduction](problem-sets/ps5/01-introduction.md)
    - [Part a.](problem-sets/ps5/02-part-a.md)
    - [Part b.](problem-sets/ps5/03-part-b.md)
    - [Part c.](problem-sets/ps5/04-part-c.md)
- [Problem Set 6](problem-sets/ps6.md)

### problem-sets/ps1_files/figure-latex

- [Unnamed chunk 2 1](problem-sets/ps1_files/figure-latex/unnamed-chunk-2-1.md)

### problem-sets/ps5_files/figure-latex

- [Unnamed chunk 12 1](problem-sets/ps5_files/figure-latex/unnamed-chunk-12-1.md)
- [Unnamed chunk 3 1](problem-sets/ps5_files/figure-latex/unnamed-chunk-3-1.md)
- [Unnamed chunk 7 1](problem-sets/ps5_files/figure-latex/unnamed-chunk-7-1.md)
...
- **protocol**
    ...
    - [3. Power Calculations](project/protocol/03-3-power-calculations.md)
    - [4. Final assignments of treatments](project/protocol/04-4-final-assignments-of-treatments.md)
...
- **no text layer (scan) — 36 chars/page** (2) — `03-potential-outcomes/3. Potential Outcomes Starter.pdf`, `03-potential-outcomes/3. Potential Outcomes.pdf`

- **no text layer (scan) — 47 chars/page** (1) — `15-main-effects/15. Main Effects And Interactions Starter.pdf`

- **no text layer (scan) — 50 chars/page** (1) — `08-power-2/8. Power II Starter.pdf`

- **no text layer (scan) — 57 chars/page** (1) — `problem-sets/ps1_files/figure-latex/unnamed-chunk-7-1.pdf`

- **render of .html with the same stem** (1) — `syllabus.pdf`

- **render of .md with the same stem** (29) — `labs/01-components-and-eda/lab.html`, `labs/01-components-and-eda/lab.pdf`, `labs/01-components-and-eda/lab.tex`, `labs/01-components-and-eda/lab1.pdf`, `labs/01-components-and-eda/lab1.tex`, `labs/02-randomization-tests/lab.html`, `labs/02-randomization-tests/lab.pdf`, `labs/02-randomization-tests/lab.tex` … and 21 more

- **render of .tex with the same stem** (6) — `labs/04-factorial-design/lab.html`, `labs/04-factorial-design/lab.pdf`, `labs/05-sequential-testing/lab.html`, `labs/05-sequential-testing/lab.pdf`, `labs/06-power-calculations/lab.html`, `labs/06-power-calculations/lab.pdf`
