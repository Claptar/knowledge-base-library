...
1. [Blocking and Variance](01-blocking-and-variance.md)
2. [Completely Randomized Design \$CR$$1$$\$](02-completely-randomized-design.md)
3. [Generalized Complete Block Design \$GCB$$1$$\$](03-generalized-complete-block-design.md)
