...
1.  Factors:
    - Experimental: college access program vs no support
    - Blocking: geographic region
2.  Experimental units: high schools
3.  Method of assignment: with each pair of schools in a region, one is randomly assigned to receive the college access program and the other is assigned to receive no support.
4.  Response variable: rate of college enrollment from each school at the end of the school year.
...
1.  Factors:
    - Experimental: drug (caffeine, theobromine, placebo)
    - Blocking: subject
2.  Experimental units: subjects
3.  Method of assignment: each subject received each of the three drugs, and the order in which they received the drugs was randomized.
4.  Response variable: rate of finger tapping two hours after receiving the drug.
...
1.  Factors:
    - Experimental: government auditing vs no auditing
    - Blocking: region
2.  Experimental units: public works projects
3.  Method of assignment: with each set of six projects in a region, two are randomly selected to receive government auditing and the other four are assigned to receive no auditing.
4.  Response variable: amount of money unaccounted for (which is presumed stolen) at the conclusion of each project.
